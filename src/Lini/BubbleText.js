...
export default function LiniBubbleText({ size, ...props }) {
    ...
    return (
        <span {...props} className={className}>
            <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 20 20">
                ...
                <path d="M13.5 7h-8a.5.5 0 010-1h8a.5.5 0 010 1zM13.5 9h-8a.5.5 0 010-1h8a.5.5 0 010 1zM13.5 11h-8a.5.5 0 010-1h8a.5.5 0 010 1zM11.5 13h-6a.5.5 0 010-1h6a.5.5 0 010 1z" />
            </svg>
        </span>
    );
}
