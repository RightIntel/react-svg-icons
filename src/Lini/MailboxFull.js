...
export default function LiniMailboxFull({ size, ...props }) {
    ...
    return (
        <span {...props} className={className}>
            <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 20 20">
                <path d="M10.5 0h-4a.5.5 0 00-.5.5v5.586c-.582.206-1 .762-1 1.414C5 8.327 5.673 9 6.5 9S8 8.327 8 7.5c0-.652-.418-1.208-1-1.414V3h3.5a.5.5 0 00.5-.5v-2a.5.5 0 00-.5-.5zm-4 8a.5.5 0 110-1 .5.5 0 010 1zM10 2H7V1h3v1z" />
