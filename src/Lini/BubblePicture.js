...
export default function LiniBubblePicture({ size, ...props }) {
    ...
    return (
        <span {...props} className={className}>
            <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 20 20">
                ...
                <path d="M11.5 11c-.827 0-1.5-.673-1.5-1.5S10.673 8 11.5 8s1.5.673 1.5 1.5-.673 1.5-1.5 1.5zm0-2a.5.5 0 100 1 .5.5 0 000-1z" />
                <path d="M14.5 6h-10a.5.5 0 00-.5.5v6a.5.5 0 00.5.5h10a.5.5 0 00.5-.5v-6a.5.5 0 00-.5-.5zM5 11.675l1.266-1.582c.071-.089.16-.139.25-.141s.181.045.255.132l1.642 1.915H5v-.325zM14 12H9.73l-2.2-2.566c-.268-.313-.645-.488-1.031-.481s-.757.195-1.014.516L5 10.075V7h9v5z" />
            </svg>
        </span>
    );
}
