...
export default function LiniAlarmError({ size, ...props }) {
    let className = 'Component Lini LiniAlarmError';
    if (props.className) {
    ...
    return (
        <span {...props} className={className}>
            <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 20 20">
                ...
                <path d="M10.207 11l3.146-3.146a.5.5 0 00-.707-.707L9.5 10.293 6.354 7.147a.5.5 0 00-.707.707L8.793 11l-3.146 3.146a.5.5 0 00.708.707l3.146-3.146 3.146 3.146a.498.498 0 00.708 0 .5.5 0 000-.707L10.209 11z" />
            </svg>
        </span>
    );
}

LiniAlarmError.propTypes = {
