...
export default function LiniEjectCircle({ size, ...props }) {
    ...
    return (
        <span {...props} className={className}>
            <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 20 20">
                ...
                <path d="M13.5 15h-8a.5.5 0 01-.5-.5v-2a.5.5 0 01.5-.5h8a.5.5 0 01.5.5v2a.5.5 0 01-.5.5zM6 14h7v-1H6v1zM13.501 11H5.5a.502.502 0 01-.416-.777l4-6a.501.501 0 01.832 0l3.987 5.981a.5.5 0 01-.403.797zm-7.067-1h6.131L9.499 5.401 6.433 10z" />
            </svg>
        </span>
    );
}
