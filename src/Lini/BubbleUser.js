...
export default function LiniBubbleUser({ size, ...props }) {
    ...
    return (
        <span {...props} className={className}>
            <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 20 20">
                ...
                <path d="M12.999 12.465a4.277 4.277 0 00-.427-1.688c-.252-.503-.679-1.066-1.399-1.421.507-.458.827-1.12.827-1.856C12 6.122 10.878 5 9.5 5S7 6.122 7 7.5c0 .736.32 1.398.827 1.856a3.083 3.083 0 00-1.399 1.421A4.25 4.25 0 006 12.501a.5.5 0 00.5.5h6.001a.5.5 0 00.5-.5L13 12.466zM8 7.5C8 6.673 8.673 6 9.5 6s1.5.673 1.5 1.5S10.327 9 9.5 9 8 8.327 8 7.5zM7.061 12c.047-.233.129-.521.275-.804C7.745 10.402 8.473 10 9.5 10s1.755.402 2.164 1.196c.145.283.228.571.275.804H7.062z" />
            </svg>
        </span>
    );
}
