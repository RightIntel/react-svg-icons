...
export default function LiniMedalThird({ size, ...props }) {
    let className = 'Component Lini LiniMedalThird';
    if (props.className) {
    ...
    return (
        <span {...props} className={className}>
            <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 20 20">
                ...
                <path d="M10.5 4h-2a.5.5 0 000 1H10v1H8.5a.5.5 0 000 1H10v1H8.5a.5.5 0 000 1h2a.5.5 0 00.5-.5v-4a.5.5 0 00-.5-.5z" />
            </svg>
        </span>
    );
}
