...
export default function LiniStopCircle({ size, ...props }) {
    ...
    return (
        <span {...props} className={className}>
            <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 20 20">
                ...
                <path d="M12.5 15h-6c-.827 0-1.5-.673-1.5-1.5v-6C5 6.673 5.673 6 6.5 6h6c.827 0 1.5.673 1.5 1.5v6c0 .827-.673 1.5-1.5 1.5zm-6-8a.5.5 0 00-.5.5v6a.5.5 0 00.5.5h6a.5.5 0 00.5-.5v-6a.5.5 0 00-.5-.5h-6z" />
            </svg>
        </span>
    );
}
