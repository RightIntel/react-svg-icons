...
export default function LiniUserPlus({ size, ...props }) {
    let className = 'Component Lini LiniUserPlus';
    if (props.className) {
    ...
    return (
        <span {...props} className={className}>
            <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 20 20">
                ...
                <path d="M17.5 15H16v-1.5a.5.5 0 00-1 0V15h-1.5a.5.5 0 000 1H15v1.5a.5.5 0 001 0V16h1.5a.5.5 0 000-1z" />
            </svg>
        </span>
    );
}

LiniUserPlus.propTypes = {
