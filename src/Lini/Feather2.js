...
export default function LiniFeather2({ size, ...props }) {
    ...
    return (
        <span {...props} className={className}>
            <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 20 20">
                ...
                <path d="M11.5 6a.501.501 0 01-.199-.959C13.272 4.186 17.737 3 18.5 3a.5.5 0 010 1c-.528 0-4.793 1.088-6.801 1.959A.5.5 0 0111.5 6z" />
            </svg>
        </span>
    );
}
