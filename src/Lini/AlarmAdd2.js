...
export default function LiniAlarmAdd2({ size, ...props }) {
    let className = 'Component Lini LiniAlarmAdd2';
    if (props.className) {
    ...
    return (
        <span {...props} className={className}>
            <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 20 20">
                ...
                <path d="M13.5 10H10V6.5a.5.5 0 00-1 0V10H5.5a.5.5 0 000 1H9v3.5a.5.5 0 001 0V11h3.5a.5.5 0 000-1z" />
            </svg>
        </span>
    );
}

LiniAlarmAdd2.propTypes = {
