...
export default function LiniClipboardDown({ size, ...props }) {
    let className = 'Component Lini LiniClipboardDown';
    if (props.className) {
    ...
    return (
        <span {...props} className={className}>
            <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 20 20">
                ...
                <path d="M9.5 3c-.132 0-.261-.053-.353-.147S9 2.631 9 2.5a.498.498 0 01.5-.5.498.498 0 01.5.5.5.5 0 01-.5.5zM11.854 12.646a.5.5 0 00-.707 0l-1.146 1.146V8.499a.5.5 0 00-1 0v5.293l-1.146-1.146a.5.5 0 00-.707.707l2 2a.498.498 0 00.708 0l2-2a.5.5 0 000-.707z" />
            </svg>
        </span>
    );
}
