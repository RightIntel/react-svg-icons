...
export default function LiniCloudLightning({ size, ...props }) {
    let className = 'Component Lini LiniCloudLightning';
    if (props.className) {
    ...
    return (
        <span {...props} className={className}>
            <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 20 20">
                ...
                <path d="M10.5 16a.5.5 0 01-.447-.724L11.191 13H9a.5.5 0 01-.447-.723l1.5-3a.5.5 0 01.895.447L9.81 12h2.191a.5.5 0 01.447.723l-1.5 3A.501.501 0 0110.5 16z" />
            </svg>
        </span>
    );
}
