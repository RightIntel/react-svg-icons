...
export default function LiniFileSpreadsheet({ size, ...props }) {
    ...
    return (
        <span {...props} className={className}>
            <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 20 20">
                ...
                <path d="M14.5 10h-9a.5.5 0 00-.5.5v6a.5.5 0 00.5.5h9a.5.5 0 00.5-.5v-6a.5.5 0 00-.5-.5zm-.5 3h-2v-2h2v2zm-5 0v-2h2v2H9zm2 1v2H9v-2h2zm-3-3v2H6v-2h2zm-2 3h2v2H6v-2zm6 2v-2h2v2h-2z" />
            </svg>
        </span>
    );
}
