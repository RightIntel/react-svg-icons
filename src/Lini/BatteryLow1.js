...
export default function LiniBatteryLow1({ size, ...props }) {
    let className = 'Component Lini LiniBatteryLow1';
    if (props.className) {
    ...
    return (
        <span {...props} className={className}>
            <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 20 20">
                ...
                <path d="M2.5 14a.5.5 0 01-.5-.5v-6a.5.5 0 011 0v6a.5.5 0 01-.5.5z" />
            </svg>
        </span>
    );
}

LiniBatteryLow1.propTypes = {
