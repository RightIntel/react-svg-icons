...
export default function LiniFolderUpload({ size, ...props }) {
    let className = 'Component Lini LiniFolderUpload';
    if (props.className) {
    ...
    return (
        <span {...props} className={className}>
            <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 20 20">
                ...
                <path d="M12.854 10.646l-3-3a.5.5 0 00-.707 0l-3 3a.5.5 0 00.707.707L9 9.207V14.5a.5.5 0 001 0V9.207l2.146 2.146a.498.498 0 00.708 0 .5.5 0 000-.707z" />
            </svg>
        </span>
    );
}
