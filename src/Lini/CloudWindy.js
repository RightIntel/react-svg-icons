...
export default function LiniCloudWindy({ size, ...props }) {
    ...
    return (
        <span {...props} className={className}>
            <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 20 20">
                <path d="M16.499 12.965a.5.5 0 01-.07-.995A3.012 3.012 0 0019 9a3.004 3.004 0 00-4-2.83.5.5 0 01-.533-.812A2.002 2.002 0 0013 1.999a2.001 2.001 0 00-1.996 1.875.501.501 0 01-.908.257A5.01 5.01 0 006 2a5.006 5.006 0 00-4.98 5.455.5.5 0 01-.996.09A6.007 6.007 0 016 1a6.01 6.01 0 014.261 1.776A3.007 3.007 0 0113 1a3.004 3.004 0 012.828 4.004A4.004 4.004 0 0120 9a3.998 3.998 0 01-3.43 3.96.578.578 0 01-.071.005z" />
                ...
                <path d="M15.5 17h-6a.5.5 0 010-1h6a.5.5 0 010 1z" />
            </svg>
        </span>
    );
}
