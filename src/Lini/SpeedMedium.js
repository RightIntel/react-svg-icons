...
export default function LiniSpeedMedium({ size, ...props }) {
    ...
    return (
        <span {...props} className={className}>
            <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 20 20">
                <path d="M9.5 15c-.827 0-1.5-.673-1.5-1.5 0-.569.84-5.173 1.008-6.09a.5.5 0 01.984 0C10.16 8.327 11 12.931 11 13.5c0 .827-.673 1.5-1.5 1.5zm0-4.666c-.283 1.619-.499 2.946-.5 3.167a.5.5 0 001 0c-.001-.221-.217-1.548-.5-3.166z" />
