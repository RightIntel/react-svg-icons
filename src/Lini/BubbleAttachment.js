...
export default function LiniBubbleAttachment({ size, ...props }) {
    ...
    return (
        <span {...props} className={className}>
            <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 20 20">
                ...
                <path d="M11.5 13h-4C5.57 13 4 11.43 4 9.5S5.57 6 7.5 6h5C13.878 6 15 7.122 15 8.5S13.878 11 12.5 11h-4C7.673 11 7 10.327 7 9.5S7.673 8 8.5 8h2a.5.5 0 010 1h-2a.5.5 0 000 1h4c.827 0 1.5-.673 1.5-1.5S13.327 7 12.5 7h-5C6.122 7 5 8.122 5 9.5S6.122 12 7.5 12h4a.5.5 0 010 1z" />
            </svg>
        </span>
    );
}
