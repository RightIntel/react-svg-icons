...
export default function LiniHddUp({ size, ...props }) {
    ...
    return (
        <span {...props} className={className}>
            <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 20 20">
                ...
                <path d="M16.5 18h-1a.5.5 0 010-1h1a.5.5 0 010 1zM16.5 16h-14a.5.5 0 010-1h14a.5.5 0 010 1zM12.854 4.646l-3-3a.5.5 0 00-.707 0l-3 3a.5.5 0 00.707.707L9 3.207V11.5a.5.5 0 001 0V3.207l2.146 2.146a.498.498 0 00.708 0 .5.5 0 000-.707z" />
            </svg>
        </span>
    );
}
