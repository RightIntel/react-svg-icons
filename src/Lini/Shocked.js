...
export default function LiniShocked({ size, ...props }) {
    ...
    return (
        <span {...props} className={className}>
            <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 20 20">
                ...
                <path d="M6.5 8a.498.498 0 01-.5-.5.498.498 0 01.5-.5.5.5 0 010 1zM12.5 8c-.132 0-.261-.053-.353-.147S12 7.631 12 7.5a.5.5 0 11.5.5z" />
            </svg>
        </span>
    );
}
