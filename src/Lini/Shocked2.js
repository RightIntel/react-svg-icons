...
export default function LiniShocked2({ size, ...props }) {
    ...
    return (
        <span {...props} className={className}>
            <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 20 20">
                ...
                <path d="M12.5 15h-6a.5.5 0 010-1h6a.5.5 0 010 1zM12.5 9c-.827 0-1.5-.673-1.5-1.5S11.673 6 12.5 6s1.5.673 1.5 1.5S13.327 9 12.5 9zm0-2a.5.5 0 100 1 .5.5 0 000-1z" />
                <path d="M12.5 4a3.501 3.501 0 00-3 1.699A3.501 3.501 0 006.5 4C4.57 4 3 5.57 3 7.5S4.57 11 6.5 11a3.501 3.501 0 003-1.699 3.501 3.501 0 003 1.699c1.93 0 3.5-1.57 3.5-3.5S14.43 4 12.5 4zm-6 6C5.122 10 4 8.878 4 7.5S5.122 5 6.5 5 9 6.122 9 7.5 7.878 10 6.5 10zm6 0C11.122 10 10 8.878 10 7.5S11.122 5 12.5 5 15 6.122 15 7.5 13.878 10 12.5 10z" />
                <path d="M6.5 9C5.673 9 5 8.327 5 7.5S5.673 6 6.5 6 8 6.673 8 7.5 7.327 9 6.5 9zm0-2a.5.5 0 100 1 .5.5 0 000-1z" />
            </svg>
        </span>
    );
}
