...
export default function LiniBatteryCharging({ size, ...props }) {
    let className = 'Component Lini LiniBatteryCharging';
    if (props.className) {
    ...
    return (
        <span {...props} className={className}>
            <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 20 20">
                ...
                <path d="M8.5 16a.501.501 0 01-.465-.686L9.761 11H6.499a.499.499 0 01-.464-.686l2-5a.501.501 0 01.929.371L7.238 9.999H10.5a.499.499 0 01.464.686l-2 5a.499.499 0 01-.464.314z" />
            </svg>
        </span>
    );
}
