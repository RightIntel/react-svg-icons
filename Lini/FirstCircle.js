...
export default function LiniFirstCircle({
  ...
  return /*#__PURE__*/React.createElement("span", _extends({}, props, {
    ...
    d: "M9.5 15a.501.501 0 01-.4-.2l-3-4a.501.501 0 010-.6l3-4a.5.5 0 01.9.3v8a.5.5 0 01-.5.5zm-2.375-4.5L9 13V8l-1.875 2.5z"
  }), /*#__PURE__*/React.createElement("path", {
    d: "M5.5 15a.5.5 0 01-.5-.5v-8a.5.5 0 011 0v8a.5.5 0 01-.5.5zM13.5 15a.501.501 0 01-.4-.2l-3-4a.501.501 0 010-.6l3-4a.5.5 0 01.9.3v8a.5.5 0 01-.5.5zm-2.375-4.5L13 13V8l-1.875 2.5z"
  })));
}
