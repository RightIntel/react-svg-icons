...
export default function LiniBackwardCircle({ size, ...props }) {
    ...
    return (
        <span {...props} className={className}>
            <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 20 20">
                ...
                <path d="M8.5 15a.5.5 0 01-.354-.147l-4-4a.5.5 0 010-.707l4-4A.499.499 0 019 6.5v8a.5.5 0 01-.5.5zm-3.293-4.5L8 13.293V7.707L5.207 10.5z" />
                <path d="M13.5 15a.5.5 0 01-.354-.147l-4-4a.5.5 0 010-.707l4-4A.499.499 0 0114 6.5v8a.5.5 0 01-.5.5zm-3.293-4.5L13 13.293V7.707L10.207 10.5z" />
            </svg>
        </span>
    );
}
