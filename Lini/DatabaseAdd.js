...
export default function LiniDatabaseAdd({
  size,
  ...props
}) {
  let className = 'Component Lini LiniDatabaseAdd';
  ...
  return /*#__PURE__*/React.createElement("span", _extends({}, props, {
    ...
    d: "M17.5 15H16v-1.5a.5.5 0 00-1 0V15h-1.5a.5.5 0 000 1H15v1.5a.5.5 0 001 0V16h1.5a.5.5 0 000-1z"
  })));
}
LiniDatabaseAdd.propTypes = {
