...
export default function LiniMapMarkerUser({ size, ...props }) {
    ...
    return (
        <span {...props} className={className}>
            <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 20 20">
                ...
                <path d="M13 9.467a4.906 4.906 0 00-.351-1.659c-.214-.514-.514-.927-.891-1.229a2.582 2.582 0 00-.303-.208A1.99 1.99 0 0012 5.001c0-1.103-.897-2-2-2s-2 .897-2 2c0 .53.208 1.012.545 1.37a2.668 2.668 0 00-.303.208c-.377.302-.677.716-.891 1.229A4.884 4.884 0 007 9.5a.5.5 0 00.5.5h5.001a.5.5 0 00.5-.5L13 9.467zM9 5c0-.551.449-1 1-1s1 .449 1 1-.449 1-1 1c-.551 0-1-.449-1-1zm-.95 4a3.69 3.69 0 01.224-.808C8.608 7.39 9.173 7 10 7c1.429 0 1.837 1.268 1.953 2H8.049z" />
            </svg>
        </span>
    );
}
