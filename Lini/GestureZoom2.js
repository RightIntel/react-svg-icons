...
function LiniGestureZoom2({
  size,
  color,
  ...props
}) {
  var className = 'Component Lini LiniGestureZoom2';
  ...
  return /*#__PURE__*/React.createElement("span", Object.assign({}, props, {
    ...
    d: "M4.507 7h-1.8l4.293-4.293v1.793c0 0.276 0.224 0.5 0.5 0.5s0.5-0.224 0.5-0.5v-3c0-0.276-0.224-0.5-0.5-0.5h-3c-0.276 0-0.5 0.224-0.5 0.5s0.224 0.5 0.5 0.5h1.793l-4.293 4.293v-1.793c0-0.276-0.224-0.5-0.5-0.5s-0.5 0.224-0.5 0.5v3c0 0.276 0.224 0.5 0.5 0.5h3.007c0.276 0 0.5-0.224 0.5-0.5s-0.224-0.5-0.5-0.5z"
  }, pathProps))));
}
...
module.exports = LiniGestureZoom2;