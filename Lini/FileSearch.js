...
export default function LiniFileSearch({ size, ...props }) {
    ...
    return (
        <span {...props} className={className}>
            <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 20 20">
                ...
                <path d="M14.882 17.177l-2.938-3.472A3.987 3.987 0 0013 11c0-2.206-1.794-4-4-4s-4 1.794-4 4 1.794 4 4 4c.804 0 1.553-.239 2.181-.648l2.937 3.471a.499.499 0 00.705.059.5.5 0 00.059-.705zM6 11c0-1.654 1.346-3 3-3s3 1.346 3 3-1.346 3-3 3-3-1.346-3-3z" />
            </svg>
        </span>
    );
}
