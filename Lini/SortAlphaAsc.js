...
function LiniSortAlphaAsc({
  size,
  color = '#000000',
  ...props
}) {
  var className = 'Component Lini LiniSortAlphaAsc';
  ...
  return /*#__PURE__*/React.createElement("span", Object.extends({}, props, {
    ...
    d: "M18.5 20h-4c-0.178 0-0.343-0.095-0.432-0.249s-0.090-0.344-0.002-0.499l3.573-6.252h-3.138c-0.276 0-0.5-0.224-0.5-0.5s0.224-0.5 0.5-0.5h4c0.178 0 0.343 0.095 0.432 0.249s0.090 0.344 0.002 0.499l-3.573 6.252h3.138c0.276 0 0.5 0.224 0.5 0.5s-0.224 0.5-0.5 0.5z",
    fill: color
  })));
}
...
module.exports = LiniSortAlphaAsc;