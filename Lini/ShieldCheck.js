...
export default function LiniShieldCheck({ size, ...props }) {
    let className = 'Component Lini LiniShieldCheck';
    if (props.className) {
    ...
    return (
        <span {...props} className={className}>
            <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 20 20">
                ...
                <path d="M8.5 12.5a.502.502 0 01-.354-.146l-2-2a.5.5 0 01.707-.707l1.646 1.646 4.646-4.646a.5.5 0 01.707.707l-5 5a.498.498 0 01-.354.146z" />
            </svg>
        </span>
    );
}

LiniShieldCheck.propTypes = {
