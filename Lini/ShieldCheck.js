...
function LiniShieldCheck({
  size,
  color = '#000000',
  ...props
}) {
  var className = 'Component Lini LiniShieldCheck';
  ...
  return /*#__PURE__*/React.createElement("span", Object.assign({}, props, {
    ...
    d: "M8.5 12.5c-0.128 0-0.256-0.049-0.354-0.146l-2-2c-0.195-0.195-0.195-0.512 0-0.707s0.512-0.195 0.707 0l1.646 1.646 4.646-4.646c0.195-0.195 0.512-0.195 0.707 0s0.195 0.512 0 0.707l-5 5c-0.098 0.098-0.226 0.146-0.354 0.146z",
    fill: color
  })));
}
...
module.exports = LiniShieldCheck;