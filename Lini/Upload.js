...
export default function LiniUpload({ size, ...props }) {
    ...
    return (
        <span {...props} className={className}>
            <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 20 20">
                <path d="M13.854 4.646l-4-4a.5.5 0 00-.707 0l-4 4a.5.5 0 00.707.707L9 2.207V12.5a.5.5 0 001 0V2.207l3.146 3.146a.498.498 0 00.708 0 .5.5 0 000-.707z" />
