...
export default function LiniMenuSquare({ size, ...props }) {
    ...
    return (
        <span {...props} className={className}>
            <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 20 20">
                ...
                <path d="M14.5 8h-10a.5.5 0 010-1h10a.5.5 0 010 1zM14.5 14h-10a.5.5 0 010-1h10a.5.5 0 010 1zM14.5 11h-10a.5.5 0 010-1h10a.5.5 0 010 1z" />
            </svg>
        </span>
    );
}
