...
export default function LiniMapMarkerCheck({ size, ...props }) {
    ...
    return (
        <span {...props} className={className}>
            <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 20 20">
                ...
                <path d="M10 9a.502.502 0 01-.354-.146l-2.5-2.5a.5.5 0 01.707-.707l2.146 2.146 5.146-5.146a.5.5 0 01.707.707l-5.5 5.5A.498.498 0 019.998 9z" />
            </svg>
        </span>
    );
}
