...
export default function LiniClipboardCheck({
  size,
  ...props
}) {
  ...
  return /*#__PURE__*/React.createElement("span", _extends({}, props, {
    ...
    d: "M9.5 3c-.132 0-.261-.053-.353-.147S9 2.631 9 2.5a.498.498 0 01.5-.5.498.498 0 01.5.5.5.5 0 01-.5.5zM8 14a.502.502 0 01-.354-.146l-1.5-1.5a.5.5 0 01.707-.707l1.146 1.146 4.146-4.146a.5.5 0 01.707.707l-4.5 4.5a.498.498 0 01-.354.146z"
  })));
}
