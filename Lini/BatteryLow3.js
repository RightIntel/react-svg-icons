...
export default function LiniBatteryLow3({
  size,
  ...props
}) {
  ...
  return /*#__PURE__*/React.createElement("span", _extends({}, props, {
    ...
    d: "M2.5 14a.5.5 0 01-.5-.5v-6a.5.5 0 011 0v6a.5.5 0 01-.5.5zM4.5 14a.5.5 0 01-.5-.5v-6a.5.5 0 011 0v6a.5.5 0 01-.5.5zM6.5 14a.5.5 0 01-.5-.5v-6a.5.5 0 011 0v6a.5.5 0 01-.5.5z"
  })));
}
