...
function LiniCoolantTemperature({
  size,
  ...props
}) {
  var className = 'Component Lini LiniCoolantTemperature';
...
module.exports = LiniCoolantTemperature;