...
export default function LiniWifiAlertLow({
  size,
  ...props
}) {
  ...
  return /*#__PURE__*/React.createElement("span", _extends({}, props, {
    ...
    d: "M4.5 10a.5.5 0 01-.5-.5v-2a.5.5 0 011 0v2a.5.5 0 01-.5.5zM4.5 12a.498.498 0 01-.5-.5.498.498 0 01.5-.5.5.5 0 010 1zM13.947 12.968a.5.5 0 01-.431-.246A3.519 3.519 0 0010.5 11a.5.5 0 010-1 4.497 4.497 0 013.876 2.213.5.5 0 01-.43.755z"
  })));
}
