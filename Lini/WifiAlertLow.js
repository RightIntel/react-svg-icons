...
function LiniWifiAlertLow({
  size,
  color,
  ...props
}) {
  var className = 'Component Lini LiniWifiAlertLow';
  ...
  return /*#__PURE__*/React.createElement("span", Object.assign({}, props, {
    ...
    d: "M12.001 8.161c-0.035 0-0.071-0.004-0.107-0.012-0.455-0.099-0.923-0.15-1.393-0.15-0.276 0-0.5-0.224-0.5-0.5s0.224-0.5 0.5-0.5c0.542 0 1.082 0.058 1.607 0.173 0.27 0.059 0.441 0.325 0.382 0.595-0.051 0.234-0.258 0.393-0.488 0.393z"
  }, pathProps)), /*#__PURE__*/React.createElement("path", Object.assign({
...
module.exports = LiniWifiAlertLow;