...
export default function LiniBagDollar({
  size,
  ...props
}) {
  let className = 'Component Lini LiniBagDollar';
  ...
  return /*#__PURE__*/React.createElement("span", _extends({}, props, {
    ...
    d: "M11.5 13H8v-1h3.5a.5.5 0 000-1H10v-.5a.5.5 0 00-1 0v.5H7.5a.5.5 0 00-.5.5v2a.5.5 0 00.5.5H11v1H7.5a.5.5 0 000 1H9v.5a.5.5 0 001 0V16h1.5a.5.5 0 00.5-.5v-2a.5.5 0 00-.5-.5z"
  }), /*#__PURE__*/React.createElement("path", {
