...
export default function LiniFileCharts({
  ...
  return /*#__PURE__*/React.createElement("span", Object.assign({}, props, {
    ...
    d: "M14.5 14h-1a.5.5 0 010-1h1a.5.5 0 010 1zM14.5 16h-1a.5.5 0 010-1h1a.5.5 0 010 1zM8.5 10a.5.5 0 00-.5.5v.5c-1.654 0-3 1.346-3 3s1.346 3 3 3 3-1.346 3-3h.5a.5.5 0 00.5-.5c0-1.93-1.57-3.5-3.5-3.5zm.5 1.05c.978.199 1.75.972 1.95 1.95H9v-1.95zM8 16c-1.103 0-2-.897-2-2s.897-2 2-2v1.5a.5.5 0 00.5.5H10c0 1.103-.897 2-2 2zM14.5 12h-1a.5.5 0 010-1h1a.5.5 0 010 1z"
  })));
}
