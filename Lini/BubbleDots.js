...
export default function LiniBubbleDots({
  size,
  ...props
}) {
  let className = 'Component Lini LiniBubbleDots';
  ...
  return /*#__PURE__*/React.createElement("span", _extends({}, props, {
    ...
    d: "M9.5 11C8.673 11 8 10.327 8 9.5S8.673 8 9.5 8s1.5.673 1.5 1.5-.673 1.5-1.5 1.5zm0-2a.5.5 0 100 1 .5.5 0 000-1zM13.5 11c-.827 0-1.5-.673-1.5-1.5S12.673 8 13.5 8s1.5.673 1.5 1.5-.673 1.5-1.5 1.5zm0-2a.5.5 0 100 1 .5.5 0 000-1zM5.5 11C4.673 11 4 10.327 4 9.5S4.673 8 5.5 8 7 8.673 7 9.5 6.327 11 5.5 11zm0-2a.5.5 0 100 1 .5.5 0 000-1z"
  })));
}
