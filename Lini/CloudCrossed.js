...
function LiniCloudCrossed({
  size,
  color = '#000000',
  ...props
}) {
  var className = 'Component Lini LiniCloudCrossed';
...
module.exports = LiniCloudCrossed;