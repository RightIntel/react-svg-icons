...
export default function LiniEgg2({ size, ...props }) {
    ...
    return (
        <span {...props} className={className}>
            <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 20 20">
                ...
                <path d="M7.5 15C5.019 15 3 12.981 3 10.5S5.019 6 7.5 6 12 8.019 12 10.5 9.981 15 7.5 15zm0-8C5.57 7 4 8.57 4 10.5S5.57 14 7.5 14s3.5-1.57 3.5-3.5S9.43 7 7.5 7z" />
                <path d="M7.5 13a.5.5 0 010-1c.827 0 1.5-.673 1.5-1.5a.5.5 0 011 0c0 1.378-1.122 2.5-2.5 2.5z" />
            </svg>
        </span>
    );
}
