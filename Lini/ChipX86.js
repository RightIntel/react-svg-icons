...
function LiniChipX86({
  size,
  color = '#000000',
  ...props
}) {
  var className = 'Component Lini LiniChipX86';
  ...
  return /*#__PURE__*/React.createElement("span", Object.assign({}, props, {
    ...
    d: "M10.5 6h-2c-0.276 0-0.5 0.224-0.5 0.5v4c0 0.276 0.224 0.5 0.5 0.5h2c0.276 0 0.5-0.224 0.5-0.5v-4c0-0.276-0.224-0.5-0.5-0.5zM10 7v1h-1v-1h1zM9 10v-1h1v1h-1z",
    fill: color
  }), /*#__PURE__*/React.createElement("path", {
    d: "M14.5 11h-2c-0.276 0-0.5-0.224-0.5-0.5v-4c0-0.276 0.224-0.5 0.5-0.5h2c0.276 0 0.5 0.224 0.5 0.5s-0.224 0.5-0.5 0.5h-1.5v1h1.5c0.276 0 0.5 0.224 0.5 0.5v2c0 0.276-0.224 0.5-0.5 0.5zM13 10h1v-1h-1v1z",
    fill: color
  })));
}
