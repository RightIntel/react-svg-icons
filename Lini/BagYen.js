...
export default function LiniBagYen({
  size,
  ...props
}) {
  let className = 'Component Lini LiniBagYen';
  ...
  return /*#__PURE__*/React.createElement("span", _extends({}, props, {
    ...
    d: "M11.5 14a.5.5 0 000-1h-1.066l1.482-2.223a.5.5 0 10-.832-.554L9.5 12.599l-1.584-2.376a.5.5 0 10-.832.554L8.566 13H7.5a.5.5 0 000 1H9v1H7.5a.5.5 0 000 1H9v.5a.5.5 0 001 0V16h1.5a.5.5 0 000-1H10v-1h1.5z"
  })));
}
LiniBagYen.propTypes = {
