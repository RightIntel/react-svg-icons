...
function LiniGesturePinch2({
  size,
  color,
  ...props
}) {
  var className = 'Component Lini LiniGesturePinch2';
...
module.exports = LiniGesturePinch2;