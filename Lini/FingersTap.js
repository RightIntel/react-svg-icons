...
export default function LiniFingersTap({
  size,
  ...props
}) {
  let className = 'Component Lini LiniFingersTap';
  ...
  return /*#__PURE__*/React.createElement("span", _extends({}, props, {
    ...
    d: "M2.5 5a.5.5 0 01-.224-.948l2-1a.5.5 0 01.447.895l-2 1A.497.497 0 012.5 5zM14.5 2a.5.5 0 01-.224-.948l2-1a.5.5 0 01.447.895l-2 1A.497.497 0 0114.5 2zM16.5 5a.497.497 0 01-.223-.053l-2-1a.5.5 0 01.447-.895l2 1A.5.5 0 0116.5 5z"
  })));
}
LiniFingersTap.propTypes = {
