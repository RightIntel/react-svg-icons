...
export default function LiniCoinEuro({
  size,
  ...props
}) {
  let className = 'Component Lini LiniCoinEuro';
  ...
  return /*#__PURE__*/React.createElement("span", _extends({}, props, {
    ...
    d: "M12.751 10.068a.5.5 0 00-.684.181 1.51 1.51 0 01-1.298.751h-2.27a1.502 1.502 0 01-1.414-1h2.414a.5.5 0 000-1h-2.5V8h2.5a.5.5 0 000-1H7.085c.206-.582.762-1 1.414-1h2.27a1.51 1.51 0 011.298.751.5.5 0 10.865-.503 2.513 2.513 0 00-2.162-1.249H8.5c-1.207 0-2.217.86-2.45 2H5.5a.5.5 0 000 1H6v1h-.5a.5.5 0 000 1h.55c.232 1.14 1.242 2 2.45 2h2.27a2.51 2.51 0 002.162-1.249.5.5 0 00-.181-.684z"
  })));
}
