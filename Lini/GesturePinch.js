...
function LiniGesturePinch({
  size,
  color = '#000000',
  ...props
}) {
  var className = 'Component Lini LiniGesturePinch';
...
module.exports = LiniGesturePinch;