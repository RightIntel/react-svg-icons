...
function LiniTrafficLights({
  size,
  color = '#000000',
  ...props
}) {
  var className = 'Component Lini LiniTrafficLights';
...
module.exports = LiniTrafficLights;