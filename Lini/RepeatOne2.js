...
export default function LiniRepeatOne2({ size, ...props }) {
    let className = 'Component Lini LiniRepeatOne2';
    if (props.className) {
    ...
    return (
        <span {...props} className={className}>
            <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 20 20">
                ...
                <path d="M10.5 13a.5.5 0 01-.5-.5V8h-.5a.5.5 0 010-1h1a.5.5 0 01.5.5v5a.5.5 0 01-.5.5z" />
            </svg>
        </span>
    );
}
