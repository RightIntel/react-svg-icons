...
export default function LiniCalendar31({ size, ...props }) {
    let className = 'Component Lini LiniCalendar31';
    if (props.className) {
    ...
    return (
        <span {...props} className={className}>
            <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 20 20">
                ...
                <path d="M9.5 16h-3a.5.5 0 010-1H9v-2H7.5a.5.5 0 010-1H9v-2H6.5a.5.5 0 010-1h3a.5.5 0 01.5.5v6a.5.5 0 01-.5.5zM13.5 16a.5.5 0 01-.5-.5v-6a.5.5 0 011 0v6a.5.5 0 01-.5.5z" />
            </svg>
        </span>
    );
}
