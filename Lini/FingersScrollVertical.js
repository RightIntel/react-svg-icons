...
function LiniFingersScrollVertical({
  size,
  color,
  ...props
}) {
  var className = 'Component Lini LiniFingersScrollVertical';
...
module.exports = LiniFingersScrollVertical;