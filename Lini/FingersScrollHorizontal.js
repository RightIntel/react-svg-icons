...
export default function LiniFingersScrollHorizontal({
  size,
  ...props
}) {
  let className = 'Component Lini LiniFingersScrollHorizontal';
  ...
  return /*#__PURE__*/React.createElement("span", _extends({}, props, {
    ...
    d: "M18.354 2.146l-2-2a.5.5 0 00-.707.707l1.146 1.146H14.5a.5.5 0 000 1h2.293l-1.146 1.146a.5.5 0 00.708.707l2-2a.5.5 0 000-.707zM4.5 2H2.207L3.353.854a.5.5 0 00-.707-.707l-2 2a.5.5 0 000 .707l2 2a.498.498 0 00.708 0 .5.5 0 000-.707L2.208 3.001h2.293a.5.5 0 000-1z"
  })));
}
LiniFingersScrollHorizontal.propTypes = {
