...
function LiniFingersCrossed({
  size,
  color,
  ...props
}) {
  var className = 'Component Lini LiniFingersCrossed';
...
module.exports = LiniFingersCrossed;