...
export default function LiniMedalSecond({ size, ...props }) {
    let className = 'Component Lini LiniMedalSecond';
    if (props.className) {
    ...
    return (
        <span {...props} className={className}>
            <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 20 20">
                ...
                <path d="M10.5 9h-2a.5.5 0 01-.5-.5v-2a.5.5 0 01.5-.5H10V5H8.5a.5.5 0 010-1h2a.5.5 0 01.5.5v2a.5.5 0 01-.5.5H9v1h1.5a.5.5 0 010 1z" />
            </svg>
        </span>
    );
}
