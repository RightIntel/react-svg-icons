...
export default function LiniFileZip({
  ...
  return /*#__PURE__*/React.createElement("span", Object.assign({}, props, {
    ...
    d: "M6.5 4h-1a.5.5 0 010-1h1a.5.5 0 010 1zM7.5 5h-1a.5.5 0 010-1h1a.5.5 0 010 1zM6.5 6h-1a.5.5 0 010-1h1a.5.5 0 010 1zM7.5 7h-1a.5.5 0 010-1h1a.5.5 0 010 1zM6.5 8h-1a.5.5 0 010-1h1a.5.5 0 010 1zM7.5 9h-1a.5.5 0 010-1h1a.5.5 0 010 1zM6.5 10c-.827 0-1.5.673-1.5 1.5v4c0 .827.673 1.5 1.5 1.5S8 16.327 8 15.5v-4c0-.827-.673-1.5-1.5-1.5zm0 1a.5.5 0 01.5.5v.5H6v-.5a.5.5 0 01.5-.5zm0 5a.5.5 0 01-.5-.5V13h1v2.5a.5.5 0 01-.5.5zM7.5 3h-1a.5.5 0 010-1h1a.5.5 0 010 1zM6.5 10h-1a.5.5 0 010-1h1a.5.5 0 010 1z"
  })));
}
