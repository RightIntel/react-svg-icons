...
function LiniPointerRight2({
  size,
  color,
  ...props
}) {
  var className = 'Component Lini LiniPointerRight2';
...
module.exports = LiniPointerRight2;