...
export default function LiniPlaylistAdd({ size, ...props }) {
    ...
    return (
        <span {...props} className={className}>
            <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 20 20">
                ...
                <path d="M10.5 13H.5a.5.5 0 010-1h10a.5.5 0 010 1zM10.5 10H.5a.5.5 0 010-1h10a.5.5 0 010 1zM10.5 0H.5a.5.5 0 000 1H5v4.793L2.854 3.647a.5.5 0 00-.707.707l3 3a.498.498 0 00.708 0l3-3a.5.5 0 00-.707-.707L6.002 5.793V1h4.5a.5.5 0 000-1z" />
            </svg>
        </span>
    );
}
