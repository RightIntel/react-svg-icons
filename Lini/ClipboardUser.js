...
export default function LiniClipboardUser({ size, ...props }) {
    ...
    return (
        <span {...props} className={className}>
            <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 20 20">
                ...
                <path d="M9.5 3c-.132 0-.261-.053-.353-.147S9 2.631 9 2.5a.498.498 0 01.5-.5.498.498 0 01.5.5.5.5 0 01-.5.5zM12.5 17h-6c-.425 0-.796-.177-1.019-.486s-.273-.717-.139-1.12c.022-.065.229-.649.849-1.232.564-.53 1.596-1.161 3.309-1.161s2.745.631 3.309 1.161c.62.583.827 1.167.849 1.232.134.403.084.811-.139 1.12S12.925 17 12.5 17zm-3-3c-2.609 0-3.204 1.692-3.209 1.709-.031.093-.03.175.002.219s.11.071.208.071h6c.098 0 .176-.027.208-.071s.033-.125.003-.217c-.032-.089-.651-1.712-3.21-1.712zM9.5 12C8.122 12 7 10.878 7 9.5S8.122 7 9.5 7 12 8.122 12 9.5 10.878 12 9.5 12zm0-4C8.673 8 8 8.673 8 9.5S8.673 11 9.5 11s1.5-.673 1.5-1.5S10.327 8 9.5 8z" />
            </svg>
        </span>
    );
}
