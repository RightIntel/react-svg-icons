...
function LiniClipboardPencil({
  size,
  color,
  ...props
}) {
  var className = 'Component Lini LiniClipboardPencil';
...
module.exports = LiniClipboardPencil;