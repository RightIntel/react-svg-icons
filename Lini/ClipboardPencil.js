...
export default function LiniClipboardPencil({
  size,
  ...props
}) {
  ...
  return /*#__PURE__*/React.createElement("span", Object.assign({}, props, {
    ...
    d: "M9.5 3c-.132 0-.261-.053-.353-.147S9 2.631 9 2.5a.498.498 0 01.5-.5.498.498 0 01.5.5.5.5 0 01-.5.5zM5 17a.5.5 0 01-.491-.598l.5-2.5a.498.498 0 01.137-.256l6.5-6.5a.5.5 0 01.707 0l2 2a.5.5 0 010 .707l-6.5 6.5a.505.505 0 01-.256.137l-2.5.5a.466.466 0 01-.098.01zm.961-2.753l-.323 1.616 1.616-.323 6.039-6.039L12 8.208l-6.039 6.039z"
  })));
}
