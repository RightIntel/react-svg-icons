...
export default function LiniBatteryCharging6({
  size,
  ...props
}) {
  ...
  return /*#__PURE__*/React.createElement("span", _extends({}, props, {
    ...
    d: "M6.5 14a.5.5 0 01-.5-.5v-1a.5.5 0 011 0v1a.5.5 0 01-.5.5zM10.5 9a.5.5 0 01-.5-.5v-1a.5.5 0 011 0v1a.5.5 0 01-.5.5zM12.5 14a.5.5 0 01-.5-.5v-6a.5.5 0 011 0v6a.5.5 0 01-.5.5z"
  })));
}
