...
export default function LiniContract3({
  ...
  return /*#__PURE__*/React.createElement("span", Object.assign({}, props, {
    ...
    d: "M5.5 12h-3a.5.5 0 000 1h1.793l-2.146 2.146a.5.5 0 00.708.707l2.146-2.146V15.5a.5.5 0 001 0v-3a.5.5 0 00-.5-.5zM16.5 8h-1.793l2.146-2.146a.5.5 0 00-.707-.707L14 7.293V5.5a.5.5 0 00-1 0v3a.5.5 0 00.5.5h3a.5.5 0 000-1z"
  })));
}
