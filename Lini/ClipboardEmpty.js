...
export default function LiniClipboardEmpty({ size, ...props }) {
    let className = 'Component Lini LiniClipboardEmpty';
    if (props.className) {
    ...
    return (
        <span {...props} className={className}>
            <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 20 20">
                ...
                <path d="M9.5 3c-.132 0-.261-.053-.353-.147S9 2.631 9 2.5a.498.498 0 01.5-.5.498.498 0 01.5.5.5.5 0 01-.5.5z" />
            </svg>
        </span>
    );
}

LiniClipboardEmpty.propTypes = {
