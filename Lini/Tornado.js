...
function LiniTornado({
  size,
  color = '#000000',
  ...props
}) {
  var className = 'Component Lini LiniTornado';
  ...
  return /*#__PURE__*/React.createElement("span", Object.extends({}, props, {
    ...
    d: "M10 20c-2.243 0-4-1.098-4-2.5 0-0.276 0.224-0.5 0.5-0.5s0.5 0.224 0.5 0.5c0 0.709 1.232 1.5 3 1.5s3-0.791 3-1.5c0-0.276 0.224-0.5 0.5-0.5s0.5 0.224 0.5 0.5c0 1.402-1.757 2.5-4 2.5z",
    fill: color
  }), /*#__PURE__*/React.createElement("path", {
    d: "M9 11c-2.046 0-3.975-0.214-5.432-0.603-1.704-0.454-2.568-1.093-2.568-1.897 0-0.276 0.224-0.5 0.5-0.5s0.5 0.224 0.5 0.5c0 0.094 0.31 0.527 1.826 0.931 1.376 0.367 3.213 0.569 5.174 0.569s3.799-0.202 5.174-0.569c1.516-0.404 1.826-0.837 1.826-0.931 0-0.276 0.224-0.5 0.5-0.5s0.5 0.224 0.5 0.5c0 0.805-0.864 1.443-2.568 1.897-1.457 0.389-3.387 0.603-5.432 0.603z",
    fill: color
  }), /*#__PURE__*/React.createElement("path", {
    d: "M8.5 14c-1.655 0-3.218-0.217-4.401-0.611-1.735-0.578-2.099-1.346-2.099-1.889 0-0.276 0.224-0.5 0.5-0.5s0.5 0.224 0.5 0.5c0 0.162 0.296 0.567 1.415 0.94 1.084 0.361 2.534 0.56 4.085 0.56s3.001-0.199 4.085-0.56c1.12-0.373 1.415-0.778 1.415-0.94 0-0.276 0.224-0.5 0.5-0.5s0.5 0.224 0.5 0.5c0 0.542-0.364 1.31-2.099 1.889-1.183 0.394-2.746 0.611-4.401 0.611z",
    fill: color
  }), /*#__PURE__*/React.createElement("path", {
    d: "M9.5 8c-2.439 0-4.738-0.212-6.472-0.598-2.037-0.453-3.028-1.075-3.028-1.902 0-0.276 0.224-0.5 0.5-0.5 0.274 0 0.497 0.221 0.5 0.494 0.043 0.132 0.573 0.583 2.43 0.972 1.643 0.344 3.799 0.534 6.070 0.534s4.427-0.19 6.070-0.534c1.857-0.389 2.387-0.84 2.43-0.972 0.003-0.273 0.226-0.494 0.5-0.494 0.276 0 0.5 0.224 0.5 0.5 0 0.827-0.99 1.45-3.028 1.902-1.734 0.385-4.033 0.598-6.472 0.598z",
    fill: color
  })));
}
