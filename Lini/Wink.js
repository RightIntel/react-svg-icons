...
export default function LiniWink({ size, ...props }) {
    let className = 'Component Lini LiniWink';
    if (props.className) {
    ...
    return (
        <span {...props} className={className}>
            <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 20 20">
                ...
                <path d="M12.5 8c-.827 0-1.5-.673-1.5-1.5S11.673 5 12.5 5s1.5.673 1.5 1.5S13.327 8 12.5 8zm0-2a.5.5 0 100 1 .5.5 0 000-1zM9.5 17A6.508 6.508 0 013 10.5a.5.5 0 011 0C4 13.533 6.467 16 9.5 16s5.5-2.467 5.5-5.5a.5.5 0 011 0c0 3.584-2.916 6.5-6.5 6.5zM7.724 6.053a.5.5 0 00-.671.224c-.004.007-.381.724-1.053.724-.671 0-1.05-.719-1.054-.726l.001.003a.5.5 0 10-.894.446.156.156 0 00.006.011l.003.006c.083.157.71 1.26 1.938 1.26 1.294 0 1.921-1.224 1.947-1.276a.5.5 0 00-.224-.671z" />
            </svg>
        </span>
    );
}
