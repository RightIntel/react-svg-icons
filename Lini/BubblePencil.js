...
export default function LiniBubblePencil({
  size,
  ...props
}) {
  let className = 'Component Lini LiniBubblePencil';
  ...
  return /*#__PURE__*/React.createElement("span", _extends({}, props, {
    ...
    d: "M12.5 13h-3a.5.5 0 010-1h3a.5.5 0 010 1zM5.5 13a.502.502 0 01-.486-.621l.5-2a.492.492 0 01.132-.232l4.5-4.5a.5.5 0 01.707 0l1.5 1.5a.5.5 0 010 .707l-4.5 4.5a.5.5 0 01-.232.132l-2 .5a.501.501 0 01-.121.015zm.951-2.244l-.264 1.057 1.057-.264L11.293 7.5l-.793-.793-4.049 4.049z"
  })));
}
