...
export default function LiniFolderSearch({ size, ...props }) {
    ...
    return (
        <span {...props} className={className}>
            <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 20 20">
                ...
                <path d="M12.9 14.2l-1.531-2.042A2.49 2.49 0 0012 10.5C12 9.122 10.878 8 9.5 8S7 9.122 7 10.5 8.122 13 9.5 13c.382 0 .745-.087 1.069-.241L12.1 14.8a.498.498 0 00.7.1.5.5 0 00.1-.7zM8 10.5C8 9.673 8.673 9 9.5 9s1.5.673 1.5 1.5-.673 1.5-1.5 1.5S8 11.327 8 10.5z" />
            </svg>
        </span>
    );
}
