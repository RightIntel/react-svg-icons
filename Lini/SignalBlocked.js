...
function LiniSignalBlocked({
  size,
  color,
  ...props
}) {
  var className = 'Component Lini LiniSignalBlocked';
  ...
  return /*#__PURE__*/React.createElement("span", Object.assign({}, props, {
    ...
    d: "M9.5 6c-2.481 0-4.5 2.019-4.5 4.5s2.019 4.5 4.5 4.5c2.481 0 4.5-2.019 4.5-4.5s-2.019-4.5-4.5-4.5zM9.5 7c0.963 0 1.836 0.391 2.47 1.023l-5.541 4.155c-0.274-0.499-0.429-1.070-0.429-1.678 0-1.93 1.57-3.5 3.5-3.5zM9.5 14c-0.963 0-1.836-0.391-2.47-1.023l5.541-4.155c0.274 0.499 0.429 1.070 0.429 1.678 0 1.93-1.57 3.5-3.5 3.5z"
  }, pathProps))));
}
...
module.exports = LiniSignalBlocked;