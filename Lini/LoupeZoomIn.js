...
export default function LiniLoupeZoomIn({ size, ...props }) {
    let className = 'Component Lini LiniLoupeZoomIn';
    if (props.className) {
    ...
    return (
        <span {...props} className={className}>
            <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 20 20">
                ...
                <path d="M12.5 10H10V7.5a.5.5 0 00-1 0V10H6.5a.5.5 0 000 1H9v2.5a.5.5 0 001 0V11h2.5a.5.5 0 000-1z" />
            </svg>
        </span>
    );
}
