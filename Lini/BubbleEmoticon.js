...
export default function LiniBubbleEmoticon({
  size,
  ...props
}) {
  ...
  return /*#__PURE__*/React.createElement("span", _extends({}, props, {
    ...
    d: "M9.5 14C7.019 14 5 11.981 5 9.5S7.019 5 9.5 5 14 7.019 14 9.5 11.981 14 9.5 14zm0-8C7.57 6 6 7.57 6 9.5S7.57 13 9.5 13 13 11.43 13 9.5 11.43 6 9.5 6z"
  }), /*#__PURE__*/React.createElement("path", {
    d: "M8.5 8c-.132 0-.261-.053-.353-.147S8 7.631 8 7.5a.5.5 0 11.5.5zM10.5 8c-.132 0-.261-.053-.353-.147S10 7.631 10 7.5a.498.498 0 01.5-.5.5.5 0 010 1zM9.5 12c-1.005 0-1.786-.453-2.197-1.276A2.97 2.97 0 017 9.5a.5.5 0 01.5-.5h4a.5.5 0 01.5.5c0 .063-.008.635-.303 1.224C11.285 11.547 10.505 12 9.5 12zm-1.412-2c.03.097.069.2.123.302.246.47.668.698 1.29.698s1.044-.228 1.29-.698c.053-.102.093-.205.123-.302H8.089z"
  })));
}
