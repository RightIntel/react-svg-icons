...
export default function LiniInbox2({
  ...
  return (
    <svg
      ...
      width={size}
      height={size}
      className={`Component Lini LiniInbox2 ${className}`}
      {...moreProps}
    >
      <g fill={color}>
        ...
        <path d="M11.854 6.646c-0.195-0.195-0.512-0.195-0.707 0l-1.146 1.146v-4.293c0-0.276-0.224-0.5-0.5-0.5s-0.5 0.224-0.5 0.5v4.293l-1.146-1.146c-0.195-0.195-0.512-0.195-0.707 0s-0.195 0.512 0 0.707l2 2c0.098 0.098 0.226 0.146 0.354 0.146s0.256-0.049 0.354-0.146l2-2c0.195-0.195 0.195-0.512-0-0.707z" />
      </g>
    </svg>
  );
}
