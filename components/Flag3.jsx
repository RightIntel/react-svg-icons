...
export default function LiniFlag3({
  ...
  return (
    <svg
      ...
      width={size}
      height={size}
      className={`Component Lini LiniFlag3 ${className}`}
      {...moreProps}
    >
      <g fill={color}>
        <path d="M1.5 19c-0.276 0-0.5-0.224-0.5-0.5v-15c0-0.276 0.224-0.5 0.5-0.5s0.5 0.224 0.5 0.5v15c0 0.276-0.224 0.5-0.5 0.5z" />
