...
export default function LiniJoystick({
  ...
  return (
    <svg
      ...
      width={size}
      height={size}
      className={`Component Lini LiniJoystick ${className}`}
      {...moreProps}
    >
      <g fill={color}>
        <path d="M13 3.5c0-1.93-1.57-3.5-3.5-3.5s-3.5 1.57-3.5 3.5c0 1.76 1.306 3.221 3 3.464v4.536c0 0.276 0.224 0.5 0.5 0.5s0.5-0.224 0.5-0.5v-4.536c1.694-0.243 3-1.704 3-3.464zM9.5 6c-1.378 0-2.5-1.122-2.5-2.5s1.122-2.5 2.5-2.5 2.5 1.122 2.5 2.5-1.122 2.5-2.5 2.5z" />
