...
export default function LiniReminder2({
  ...
  return (
    <svg
      ...
      width={size}
      height={size}
      className={`Component Lini LiniReminder2 ${className}`}
      {...moreProps}
    >
      <g fill={color}>
        <path d="M14 17.5c0 0.276-0.224 0.5-0.5 0.5s-0.5-0.224-0.5-0.5c0-0.276 0.224-0.5 0.5-0.5s0.5 0.224 0.5 0.5z" />
        <path d="M9.5 4c-0.276 0-0.5-0.224-0.5-0.5s-0.224-0.5-0.5-0.5-0.5 0.224-0.5 0.5c0 0.276-0.224 0.5-0.5 0.5s-0.5-0.224-0.5-0.5c0-0.827 0.673-1.5 1.5-1.5s1.5 0.673 1.5 1.5c0 0.276-0.224 0.5-0.5 0.5z" />
