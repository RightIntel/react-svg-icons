...
export default function LiniRepeatOne(props = {}) {
  props.name = "RepeatOne";
  ...
  return (
    <Lini {...props}>
      ...
      <path d="M9.5 13c-0.276 0-0.5-0.224-0.5-0.5v-4.5h-0.5c-0.276 0-0.5-0.224-0.5-0.5s0.224-0.5 0.5-0.5h1c0.276 0 0.5 0.224 0.5 0.5v5c0 0.276-0.224 0.5-0.5 0.5z" />
    </Lini>
  );
}
