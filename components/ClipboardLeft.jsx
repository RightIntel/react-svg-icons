...
export default function LiniClipboardLeft({
  ...
  return (
    <svg
      ...
      width={size}
      height={size}
      className={`Component Lini LiniClipboardLeft ${className}`}
      {...moreProps}
    >
      <g fill={color}>
        ...
        <path d="M12.5 11h-5.293l1.146-1.146c0.195-0.195 0.195-0.512 0-0.707s-0.512-0.195-0.707 0l-2 2c-0.195 0.195-0.195 0.512 0 0.707l2 2c0.098 0.098 0.226 0.146 0.354 0.146s0.256-0.049 0.354-0.146c0.195-0.195 0.195-0.512 0-0.707l-1.146-1.146h5.293c0.276 0 0.5-0.224 0.5-0.5s-0.224-0.5-0.5-0.5z" />
      </g>
    </svg>
  );
}
