...
export default function LiniGestureZoom({
  ...
  return (
    <svg
      ...
      width={size}
      height={size}
      className={`Component Lini LiniGestureZoom ${className}`}
      {...moreProps}
    >
      <g fill={color}>
        ...
        <path d="M5.5 0h-2c-0.276 0-0.5 0.224-0.5 0.5s0.224 0.5 0.5 0.5h0.793l-3.293 3.293v-0.793c0-0.276-0.224-0.5-0.5-0.5s-0.5 0.224-0.5 0.5v2c0 0.276 0.224 0.5 0.5 0.5h2c0.276 0 0.5-0.224 0.5-0.5s-0.224-0.5-0.5-0.5h-0.793l3.293-3.293v0.793c0 0.276 0.224 0.5 0.5 0.5s0.5-0.224 0.5-0.5v-2c0-0.276-0.224-0.5-0.5-0.5z" />
      </g>
    </svg>
  );
}
