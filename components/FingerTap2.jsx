...
export default function LiniFingerTap2({
  ...
  return (
    <svg
      ...
      width={size}
      height={size}
      className={`Component Lini LiniFingerTap2 ${className}`}
      {...moreProps}
    >
      <g fill={color}>
        ...
        <path d="M12.5 6c-0.276 0-0.5-0.224-0.5-0.5v-1c0-1.93-1.57-3.5-3.5-3.5s-3.5 1.57-3.5 3.5v1c0 0.276-0.224 0.5-0.5 0.5s-0.5-0.224-0.5-0.5v-1c0-2.481 2.019-4.5 4.5-4.5s4.5 2.019 4.5 4.5v1c0 0.276-0.224 0.5-0.5 0.5z" />
      </g>
    </svg>
  );
}
