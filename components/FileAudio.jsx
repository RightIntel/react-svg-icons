...
export default function LiniFileAudio({
  ...
  return (
    <svg
      ...
      width={size}
      height={size}
      className={`Component Lini LiniFileAudio ${className}`}
      {...moreProps}
    >
      <g fill={color}>
