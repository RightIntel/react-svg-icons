...
export default function LiniTrafficLights({
  ...
  return (
    <svg
      ...
      width={size}
      height={size}
      className={`Component Lini LiniTrafficLights ${className}`}
      {...moreProps}
    >
      <g fill={color}>
        ...
        <path d="M10 17c-1.103 0-2-0.897-2-2s0.897-2 2-2c1.103 0 2 0.897 2 2s-0.897 2-2 2zM10 14c-0.551 0-1 0.449-1 1s0.449 1 1 1c0.551 0 1-0.449 1-1s-0.449-1-1-1z" />
