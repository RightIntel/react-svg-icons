...
export default function LiniAlarmCheck({
  ...
  return (
    <svg
      ...
      width={size}
      height={size}
      className={`Component Lini LiniAlarmCheck ${className}`}
      {...moreProps}
    >
      <g fill={color}>
        ...
        <path d="M7 14c-0.128 0-0.256-0.049-0.354-0.146l-2.5-2.5c-0.195-0.195-0.195-0.512 0-0.707s0.512-0.195 0.707 0l2.146 2.146 6.146-6.146c0.195-0.195 0.512-0.195 0.707 0s0.195 0.512 0 0.707l-6.5 6.5c-0.098 0.098-0.226 0.146-0.354 0.146z" />
      </g>
    </svg>
  );
}
