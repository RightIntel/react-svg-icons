...
export default function LiniUserMinus({
  size = 20,
  color = "",
  className = "",
  ...moreProps
  ...
  return (
    <svg
      ...
      width={size}
      height={size}
      className={`Component Lini LiniUserMinus ${className}`}
      {...moreProps}
    >
      <g fill={color}>
        ...
        <path d="M17.5 16h-4c-0.276 0-0.5-0.224-0.5-0.5s0.224-0.5 0.5-0.5h4c0.276 0 0.5 0.224 0.5 0.5s-0.224 0.5-0.5 0.5z" />
      </g>
    </svg>
  );
}
