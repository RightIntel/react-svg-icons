...
export default function LiniFolderPicture({
  ...
  return (
    <svg
      ...
      width={size}
      height={size}
      className={`Component Lini LiniFolderPicture ${className}`}
      {...moreProps}
    >
      <g fill={color}>
        ...
        <path d="M12.5 13c0.827 0 1.5-0.673 1.5-1.5s-0.673-1.5-1.5-1.5-1.5 0.673-1.5 1.5 0.673 1.5 1.5 1.5zM12.5 11c0.276 0 0.5 0.224 0.5 0.5s-0.224 0.5-0.5 0.5-0.5-0.224-0.5-0.5 0.224-0.5 0.5-0.5z" />
