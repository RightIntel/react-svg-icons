...
export default function LiniFactory({
  ...
  return (
    <svg
      ...
      width={size}
      height={size}
      className={`Component Lini LiniFactory ${className}`}
      {...moreProps}
    >
      <g fill={color}>
        ...
        <path d="M2.5 6c-0.827 0-1.5-0.673-1.5-1.5s0.673-1.5 1.5-1.5 1.5 0.673 1.5 1.5-0.673 1.5-1.5 1.5zM2.5 4c-0.276 0-0.5 0.224-0.5 0.5s0.224 0.5 0.5 0.5 0.5-0.224 0.5-0.5-0.224-0.5-0.5-0.5z" />
        <path d="M6 4c-1.122 0-2-0.659-2-1.5s0.878-1.5 2-1.5 2 0.659 2 1.5-0.878 1.5-2 1.5zM6 2c-0.61 0-1 0.296-1 0.5s0.39 0.5 1 0.5 1-0.296 1-0.5-0.39-0.5-1-0.5z" />
        <path d="M12 4c-1.682 0-3-0.878-3-2s1.318-2 3-2 3 0.878 3 2-1.318 2-3 2zM12 1c-1.145 0-2 0.528-2 1s0.855 1 2 1 2-0.528 2-1-0.855-1-2-1z" />
      </g>
    </svg>
  );
}
