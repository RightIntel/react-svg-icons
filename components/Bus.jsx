...
export default function LiniBus({
  ...
  return (
    <svg
      ...
      width={size}
      height={size}
      className={`Component Lini LiniBus ${className}`}
      {...moreProps}
    >
      <g fill={color}>
        <path d="M6.5 13h-4c-0.276 0-0.5-0.224-0.5-0.5v-3c0-0.276 0.224-0.5 0.5-0.5h4c0.276 0 0.5 0.224 0.5 0.5v3c0 0.276-0.224 0.5-0.5 0.5zM3 12h3v-2h-3v2z" />
        <path d="M12.5 13h-4c-0.276 0-0.5-0.224-0.5-0.5v-3c0-0.276 0.224-0.5 0.5-0.5h4c0.276 0 0.5 0.224 0.5 0.5v3c0 0.276-0.224 0.5-0.5 0.5zM9 12h3v-2h-3v2z" />
