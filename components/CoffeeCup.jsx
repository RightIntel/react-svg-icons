...
export default function LiniCoffeeCup({
  ...
  return (
    <svg
      ...
      width={size}
      height={size}
      className={`Component Lini LiniCoffeeCup ${className}`}
      {...moreProps}
    >
      <g fill={color}>
        <path d="M10 15c-1.654 0-3-1.346-3-3s1.346-3 3-3 3 1.346 3 3-1.346 3-3 3zM10 10c-1.103 0-2 0.897-2 2s0.897 2 2 2c1.103 0 2-0.897 2-2s-0.897-2-2-2z" />
