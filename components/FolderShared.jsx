...
export default function LiniFolderShared(props = {}) {
  props.name = "FolderShared";
  ...
  return (
    <Lini {...props}>
      ...
      <path d="M9.5 15c-0.863 0-1.691-0.317-2.334-0.891-0.206-0.184-0.223-0.5-0.039-0.706s0.5-0.223 0.706-0.039c0.459 0.411 1.050 0.637 1.667 0.637 1.378 0 2.5-1.122 2.5-2.5 0-0.276 0.224-0.5 0.5-0.5h2c0.276 0 0.5 0.224 0.5 0.5s-0.224 0.5-0.5 0.5h-1.536c-0.243 1.694-1.704 3-3.464 3z" />
      <path d="M6.5 12h-2c-0.276 0-0.5-0.224-0.5-0.5s0.224-0.5 0.5-0.5h1.536c0.243-1.694 1.704-3 3.464-3 0.863 0 1.691 0.317 2.333 0.891 0.206 0.184 0.223 0.5 0.039 0.706s-0.5 0.223-0.706 0.039c-0.459-0.41-1.050-0.636-1.667-0.636-1.378 0-2.5 1.122-2.5 2.5 0 0.276-0.224 0.5-0.5 0.5z" />
