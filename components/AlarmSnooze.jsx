...
export default function LiniAlarmSnooze(props = {}) {
  props.name = "AlarmSnooze";
  
  return (
    <Lini {...props}>
      <path d="M19.5 5h-3c-0.189 0-0.363-0.107-0.447-0.276s-0.066-0.372 0.047-0.524l2.4-3.2h-2c-0.276 0-0.5-0.224-0.5-0.5s0.224-0.5 0.5-0.5h3c0.189 0 0.363 0.107 0.447 0.276s0.066 0.372-0.047 0.524l-2.4 3.2h2c0.276 0 0.5 0.224 0.5 0.5s-0.224 0.5-0.5 0.5z" />
      <path d="M2.5 5h-2c-0.184 0-0.354-0.102-0.441-0.264s-0.077-0.36 0.025-0.513l1.482-2.223h-1.066c-0.276 0-0.5-0.224-0.5-0.5s0.224-0.5 0.5-0.5h2c0.184 0 0.354 0.102 0.441 0.264s0.077 0.36-0.025 0.513l-1.482 2.223h1.066c0.276 0 0.5 0.224 0.5 0.5s-0.224 0.5-0.5 0.5z" />
