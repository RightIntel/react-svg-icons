...
export default function LiniClapboardPlay({
  ...
  return (
    <svg
      ...
      width={size}
      height={size}
      className={`Component Lini LiniClapboardPlay ${className}`}
      {...moreProps}
    >
      <g fill={color}>
        ...
        <path d="M7.5 15c-0.085 0-0.17-0.022-0.246-0.065-0.157-0.089-0.254-0.255-0.254-0.435v-6c0-0.18 0.097-0.346 0.254-0.435s0.349-0.086 0.504 0.006l5 3c0.151 0.090 0.243 0.253 0.243 0.429s-0.092 0.338-0.243 0.429l-5 3c-0.079 0.047-0.168 0.071-0.257 0.071zM8 9.383v4.234l3.528-2.117-3.528-2.117z" />
      </g>
    </svg>
  );
}
