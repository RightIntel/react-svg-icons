...
export default function LiniPizza({
  ...
  return (
    <svg
      ...
      width={size}
      height={size}
      className={`Component Lini LiniPizza ${className}`}
      {...moreProps}
    >
      <g fill={color}>
        ...
        <path d="M4.5 5h1c0.276 0 0.5-0.224 0.5-0.5s-0.224-0.5-0.5-0.5h-1c-0.276 0-0.5 0.224-0.5 0.5s0.224 0.5 0.5 0.5z" />
        <path d="M11.5 13c0.276 0 0.5-0.224 0.5-0.5v-1c0-0.276-0.224-0.5-0.5-0.5s-0.5 0.224-0.5 0.5v1c0 0.276 0.224 0.5 0.5 0.5z" />
      </g>
    </svg>
  );
}
