...
export default function LiniSortNumericAsc({
  size = 20,
  color = "",
  className = "",
  ...moreProps
  ...
  return (
    <svg
      ...
      width={size}
      height={size}
      className={`Component Lini LiniSortNumericAsc ${className}`}
      {...moreProps}
    >
      <g fill={color}>
