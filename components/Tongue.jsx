...
export default function LiniTongue({
  size = 20,
  color = "",
  className = "",
  ...moreProps
  ...
  return (
    <svg
      ...
      width={size}
      height={size}
      className={`Component Lini LiniTongue ${className}`}
      {...moreProps}
    >
      <g fill={color}>
        ...
        <path d="M13.5 12h-8c-0.276 0-0.5 0.224-0.5 0.5s0.224 0.5 0.5 0.5h3.5v1c0 1.103 0.897 2 2 2s2-0.897 2-2v-1h0.5c0.276 0 0.5-0.224 0.5-0.5s-0.224-0.5-0.5-0.5zM12 14c0 0.551-0.449 1-1 1s-1-0.449-1-1v-1h2v1z" />
      </g>
    </svg>
  );
}
