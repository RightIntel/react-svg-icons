...
export default function LiniPhoneMinus({
  ...
  return (
    <svg
      ...
      width={size}
      height={size}
      className={`Component Lini LiniPhoneMinus ${className}`}
      {...moreProps}
    >
      <g fill={color}>
        ...
        <path d="M18.5 5h-6c-0.276 0-0.5-0.224-0.5-0.5s0.224-0.5 0.5-0.5h6c0.276 0 0.5 0.224 0.5 0.5s-0.224 0.5-0.5 0.5z" />
      </g>
    </svg>
  );
}
