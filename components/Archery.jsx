...
export default function LiniArchery({
  ...
  return (
    <svg
      ...
      width={size}
      height={size}
      className={`Component Lini LiniArchery ${className}`}
      {...moreProps}
    >
      <g fill={color}>
        ...
        <path d="M16.5 4h-1.5v-1.5c0-0.276-0.224-0.5-0.5-0.5s-0.5 0.224-0.5 0.5v1.768c-0.685 0.585-3.14 2.732-4.89 4.92-0.173 0.216-0.138 0.53 0.078 0.703 0.092 0.074 0.202 0.11 0.312 0.11 0.147 0 0.292-0.064 0.391-0.188 1.705-2.131 4.188-4.295 4.793-4.812h1.817c0.276 0 0.5-0.224 0.5-0.5s-0.224-0.5-0.5-0.5z" />
        <path d="M18.5 3h-2c-0.276 0-0.5-0.224-0.5-0.5v-2c0-0.276 0.224-0.5 0.5-0.5s0.5 0.224 0.5 0.5v1.5h1.5c0.276 0 0.5 0.224 0.5 0.5s-0.224 0.5-0.5 0.5z" />
        <path d="M9.5 12c-1.378 0-2.5-1.122-2.5-2.5 0-1.141 0.771-2.137 1.875-2.421 0.268-0.069 0.54 0.092 0.609 0.36s-0.092 0.54-0.36 0.609c-0.662 0.17-1.125 0.768-1.125 1.453 0 0.827 0.673 1.5 1.5 1.5s1.5-0.673 1.5-1.5c0-0.276 0.224-0.5 0.5-0.5s0.5 0.224 0.5 0.5c0 1.378-1.122 2.5-2.5 2.5z" />
      </g>
    </svg>
  );
}
