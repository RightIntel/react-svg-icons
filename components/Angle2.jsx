...
export default function LiniAngle2({
  ...
  return (
    <svg
      ...
      width={size}
      height={size}
      className={`Component Lini LiniAngle2 ${className}`}
      {...moreProps}
    >
      <g fill={color}>
        ...
        <path d="M18.5 9c-0.827 0-1.5-0.673-1.5-1.5s0.673-1.5 1.5-1.5 1.5 0.673 1.5 1.5-0.673 1.5-1.5 1.5zM18.5 7c-0.276 0-0.5 0.224-0.5 0.5s0.224 0.5 0.5 0.5 0.5-0.224 0.5-0.5-0.224-0.5-0.5-0.5z" />
      </g>
    </svg>
  );
}
