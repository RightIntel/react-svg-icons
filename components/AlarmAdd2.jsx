...
export default function LiniAlarmAdd2({
  ...
  return (
    <svg
      ...
      width={size}
      height={size}
      className={`Component Lini LiniAlarmAdd2 ${className}`}
      {...moreProps}
    >
      <g fill={color}>
        ...
        <path d="M13.5 10h-3.5v-3.5c0-0.276-0.224-0.5-0.5-0.5s-0.5 0.224-0.5 0.5v3.5h-3.5c-0.276 0-0.5 0.224-0.5 0.5s0.224 0.5 0.5 0.5h3.5v3.5c0 0.276 0.224 0.5 0.5 0.5s0.5-0.224 0.5-0.5v-3.5h3.5c0.276 0 0.5-0.224 0.5-0.5s-0.224-0.5-0.5-0.5z" />
      </g>
    </svg>
  );
}
