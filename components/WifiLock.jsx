...
export default function LiniWifiLock({
  ...
  return (
    <svg
      ...
      width={size}
      height={size}
      className={`Component Lini LiniWifiLock ${className}`}
      {...moreProps}
    >
      <g fill={color}>
