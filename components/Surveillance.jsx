...
export default function LiniSurveillance(props = {}) {
  props.name = "Surveillance";
  
  return (
    <Lini {...props}>
      <path d="M13.006 5.5c0 0.276-0.225 0.5-0.503 0.5s-0.503-0.224-0.503-0.5c0-0.276 0.225-0.5 0.503-0.5s0.503 0.224 0.503 0.5z" />
