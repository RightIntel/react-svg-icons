...
export default function LiniClipboardAlert(props = {}) {
  props.name = "ClipboardAlert";
  ...
  return (
    <Lini {...props}>
      ...
      <path d="M9.5 13c-0.276 0-0.5-0.224-0.5-0.5v-4c0-0.276 0.224-0.5 0.5-0.5s0.5 0.224 0.5 0.5v4c0 0.276-0.224 0.5-0.5 0.5z" />
