...
export default function LiniFingersScrollVertical2({
  ...
  return (
    <svg
      ...
      width={size}
      height={size}
      className={`Component Lini LiniFingersScrollVertical2 ${className}`}
      {...moreProps}
    >
      <g fill={color}>
        <path d="M16.5 6c0.276 0 0.5 0.224 0.5 0.5s-0.224 0.5-0.5 0.5c-0.276 0-0.5-0.224-0.5-0.5s0.224-0.5 0.5-0.5z" />
        ...
        <path d="M3.146 1.646l-2 2c-0.195 0.195-0.195 0.512 0 0.707s0.512 0.195 0.707 0l1.146-1.146v3.293c0 0.276 0.224 0.5 0.5 0.5s0.5-0.224 0.5-0.5v-3.293l1.146 1.146c0.195 0.195 0.512 0.195 0.707 0 0.098-0.098 0.146-0.226 0.146-0.354s-0.049-0.256-0.146-0.354l-2-2c-0.195-0.195-0.512-0.195-0.707 0z" />
        <path d="M3 14.5v3.293l-1.146-1.146c-0.195-0.195-0.512-0.195-0.707 0s-0.195 0.512 0 0.707l2 2c0.195 0.195 0.512 0.195 0.707 0l2-2c0.098-0.098 0.146-0.226 0.146-0.354s-0.049-0.256-0.146-0.354c-0.195-0.195-0.512-0.195-0.707 0l-1.146 1.146v-3.293c0-0.276-0.224-0.5-0.5-0.5s-0.5 0.224-0.5 0.5z" />
      </g>
    </svg>
  );
}
