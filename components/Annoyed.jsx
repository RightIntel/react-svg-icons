...
export default function LiniAnnoyed({
  ...
  return (
    <svg
      ...
      width={size}
      height={size}
      className={`Component Lini LiniAnnoyed ${className}`}
      {...moreProps}
    >
      <g fill={color}>
        <path d="M9.5 20c-2.538 0-4.923-0.988-6.718-2.782s-2.782-4.18-2.782-6.717c0-2.538 0.988-4.923 2.782-6.718s4.18-2.783 6.718-2.783c2.538 0 4.923 0.988 6.718 2.783s2.782 4.18 2.782 6.718-0.988 4.923-2.782 6.717c-1.794 1.794-4.18 2.782-6.718 2.782zM9.5 2c-4.687 0-8.5 3.813-8.5 8.5s3.813 8.5 8.5 8.5 8.5-3.813 8.5-8.5-3.813-8.5-8.5-8.5z" />
        <path d="M14 11h-9c-1.103 0-2 0.897-2 2s0.897 2 2 2h9c1.103 0 2-0.897 2-2s-0.897-2-2-2zM10 12h2v2h-2v-2zM9 14h-2l-0-2h2v2zM4 13c0-0.551 0.449-1 1-1h1l0 2h-1c-0.551 0-1-0.449-1-1zM14 14h-1v-2h1c0.551 0 1 0.449 1 1s-0.449 1-1 1z" />
