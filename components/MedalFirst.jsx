...
export default function LiniMedalFirst({
  ...
  return (
    <svg
      ...
      width={size}
      height={size}
      className={`Component Lini LiniMedalFirst ${className}`}
      {...moreProps}
    >
      <g fill={color}>
        ...
        <path d="M9.5 9c-0.276 0-0.5-0.224-0.5-0.5v-3.5h-0.5c-0.276 0-0.5-0.224-0.5-0.5s0.224-0.5 0.5-0.5h1c0.276 0 0.5 0.224 0.5 0.5v4c0 0.276-0.224 0.5-0.5 0.5z" />
      </g>
    </svg>
  );
}
