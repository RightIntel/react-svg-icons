...
export default function LiniFeather2({
  ...
  return (
    <svg
      ...
      width={size}
      height={size}
      className={`Component Lini LiniFeather2 ${className}`}
      {...moreProps}
    >
      <g fill={color}>
        ...
        <path d="M11.5 6c-0.193 0-0.377-0.113-0.459-0.301-0.11-0.253 0.006-0.548 0.26-0.658 1.971-0.855 6.436-2.041 7.199-2.041 0.276 0 0.5 0.224 0.5 0.5s-0.224 0.5-0.5 0.5c-0.528 0-4.793 1.088-6.801 1.959-0.065 0.028-0.132 0.041-0.199 0.041z" />
      </g>
    </svg>
  );
}
