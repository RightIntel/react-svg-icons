...
export default function LiniSlingshot(props = {}) {
  props.name = "Slingshot";
  
  return (
    <Lini {...props}>
      <path d="M10.5 20h-1c-0.827 0-1.5-0.673-1.5-1.5v-1.5c0-0.276 0.224-0.5 0.5-0.5s0.5 0.224 0.5 0.5v1.5c0 0.276 0.224 0.5 0.5 0.5h1c0.276 0 0.5-0.224 0.5-0.5v-1.5c0-0.276 0.224-0.5 0.5-0.5s0.5 0.224 0.5 0.5v1.5c0 0.827-0.673 1.5-1.5 1.5z" />
      ...
      <path d="M10 16c-1.87 0-3.628-0.728-4.95-2.050s-2.050-3.080-2.050-4.95v-5.5c0-0.276 0.224-0.5 0.5-0.5s0.5 0.224 0.5 0.5v5.5c0 3.308 2.692 6 6 6s6-2.692 6-6v-5.5c0-0.276 0.224-0.5 0.5-0.5s0.5 0.224 0.5 0.5v5.5c0 1.87-0.728 3.628-2.050 4.95s-3.080 2.050-4.95 2.050z" />
    </Lini>
  );
}
