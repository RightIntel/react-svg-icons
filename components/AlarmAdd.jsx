...
export default function LiniAlarmAdd({
  ...
  return (
    <svg
      ...
      width={size}
      height={size}
      className={`Component Lini LiniAlarmAdd ${className}`}
      {...moreProps}
    >
      <g fill={color}>
        ...
        <path d="M11.5 9h-1.5v-1.5c0-0.276-0.224-0.5-0.5-0.5s-0.5 0.224-0.5 0.5v1.5h-1.5c-0.276 0-0.5 0.224-0.5 0.5s0.224 0.5 0.5 0.5h1.5v1.5c0 0.276 0.224 0.5 0.5 0.5s0.5-0.224 0.5-0.5v-1.5h1.5c0.276 0 0.5-0.224 0.5-0.5s-0.224-0.5-0.5-0.5z" />
      </g>
    </svg>
  );
}
