...
export default function LiniLibrary({
  ...
  return (
    <svg
      ...
      width={size}
      height={size}
      className={`Component Lini LiniLibrary ${className}`}
      {...moreProps}
    >
      <g fill={color}>
        ...
        <path d="M5.5 6h-2.859c-0.276 0-0.5-0.224-0.5-0.5s0.224-0.5 0.5-0.5h2.859c0.276 0 0.5 0.224 0.5 0.5s-0.224 0.5-0.5 0.5z" />
        ...
        <path d="M15.79 4.857l-0.993 0.122c-0.274 0.034-0.524-0.161-0.557-0.435s0.161-0.524 0.435-0.557l0.993-0.122c0.274-0.034 0.524 0.161 0.557 0.435s-0.161 0.524-0.435 0.557z" />
      </g>
    </svg>
  );
}
