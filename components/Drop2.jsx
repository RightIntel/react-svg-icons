...
export default function LiniDrop2({
  size = 20,
  color = "",
  className = "",
  ...moreProps
  ...
  return (
    <svg
      ...
      width={size}
      height={size}
      className={`Component Lini LiniDrop2 ${className}`}
      {...moreProps}
    >
      <g fill={color}>
        ...
        <path d="M10 17c-0.777 0-1.505-0.319-2.049-0.899-0.608-0.648-0.943-1.571-0.943-2.601 0-0.276 0.224-0.5 0.5-0.5s0.5 0.224 0.5 0.5c0 0.774 0.239 1.455 0.672 1.916 0.354 0.377 0.823 0.584 1.321 0.584 0.141 0 0.28-0.015 0.413-0.045 0.269-0.061 0.537 0.108 0.598 0.377s-0.108 0.537-0.377 0.598c-0.205 0.046-0.418 0.070-0.634 0.070z" />
      </g>
    </svg>
  );
}
