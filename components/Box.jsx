...
export default function LiniBox({
  ...
  return (
    <svg
      ...
      width={size}
      height={size}
      className={`Component Lini LiniBox ${className}`}
      {...moreProps}
    >
      <g fill={color}>
        ...
        <path d="M12.5 16h-5c-0.827 0-1.5-0.673-1.5-1.5s0.673-1.5 1.5-1.5h5c0.827 0 1.5 0.673 1.5 1.5s-0.673 1.5-1.5 1.5zM7.5 14c-0.276 0-0.5 0.224-0.5 0.5s0.224 0.5 0.5 0.5h5c0.276 0 0.5-0.224 0.5-0.5s-0.224-0.5-0.5-0.5h-5z" />
      </g>
    </svg>
  );
}
