...
export default function LiniBubblePencil({
  ...
  return (
    <svg
      ...
      width={size}
      height={size}
      className={`Component Lini LiniBubblePencil ${className}`}
      {...moreProps}
    >
      <g fill={color}>
        ...
        <path d="M12.5 13h-3c-0.276 0-0.5-0.224-0.5-0.5s0.224-0.5 0.5-0.5h3c0.276 0 0.5 0.224 0.5 0.5s-0.224 0.5-0.5 0.5z" />
