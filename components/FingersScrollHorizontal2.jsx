...
export default function LiniFingersScrollHorizontal2({
  ...
  return (
    <svg
      ...
      width={size}
      height={size}
      className={`Component Lini LiniFingersScrollHorizontal2 ${className}`}
      {...moreProps}
    >
      <g fill={color}>
        ...
        <path d="M18.354 4.146l-2-2c-0.195-0.195-0.512-0.195-0.707 0s-0.195 0.512 0 0.707l1.146 1.146h-3.293c-0.276 0-0.5 0.224-0.5 0.5s0.224 0.5 0.5 0.5h3.293l-1.146 1.146c-0.195 0.195-0.195 0.512 0 0.707 0.098 0.098 0.226 0.146 0.354 0.146s0.256-0.049 0.354-0.146l2-2c0.195-0.195 0.195-0.512 0-0.707z" />
        <path d="M5.5 4h-3.293l1.146-1.146c0.195-0.195 0.195-0.512 0-0.707s-0.512-0.195-0.707 0l-2 2c-0.195 0.195-0.195 0.512 0 0.707l2 2c0.098 0.098 0.226 0.146 0.354 0.146s0.256-0.049 0.354-0.146c0.195-0.195 0.195-0.512 0-0.707l-1.146-1.146h3.293c0.276 0 0.5-0.224 0.5-0.5s-0.224-0.5-0.5-0.5z" />
      </g>
    </svg>
  );
}
