...
export default function LiniChipX64({
  ...
  return (
    <svg
      ...
      width={size}
      height={size}
      className={`Component Lini LiniChipX64 ${className}`}
      {...moreProps}
    >
      <g fill={color}>
        ...
        <path d="M10.5 11h-2c-0.276 0-0.5-0.224-0.5-0.5v-4c0-0.276 0.224-0.5 0.5-0.5h2c0.276 0 0.5 0.224 0.5 0.5s-0.224 0.5-0.5 0.5h-1.5v1h1.5c0.276 0 0.5 0.224 0.5 0.5v2c0 0.276-0.224 0.5-0.5 0.5zM9 10h1v-1h-1v1z" />
        <path d="M14.5 6c-0.276 0-0.5 0.224-0.5 0.5v1.5h-1v-1.5c0-0.276-0.224-0.5-0.5-0.5s-0.5 0.224-0.5 0.5v2c0 0.276 0.224 0.5 0.5 0.5h1.5v1.5c0 0.276 0.224 0.5 0.5 0.5s0.5-0.224 0.5-0.5v-4c0-0.276-0.224-0.5-0.5-0.5z" />
      </g>
    </svg>
  );
}
