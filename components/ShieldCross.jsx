...
export default function LiniShieldCross(props = {}) {
  props.name = "ShieldCross";
  ...
  return (
    <Lini {...props}>
      ...
      <path d="M13.325 12.12l-3.057-2.62 3.057-2.62c0.21-0.18 0.234-0.495 0.054-0.705s-0.495-0.234-0.705-0.054l-3.175 2.721-3.175-2.721c-0.21-0.18-0.525-0.155-0.705 0.054s-0.155 0.525 0.054 0.705l3.057 2.62-3.057 2.62c-0.21 0.18-0.234 0.495-0.054 0.705 0.099 0.115 0.239 0.175 0.38 0.175 0.115 0 0.231-0.040 0.325-0.12l3.175-2.721 3.175 2.721c0.094 0.081 0.21 0.12 0.325 0.12 0.141 0 0.281-0.059 0.38-0.175 0.18-0.21 0.155-0.525-0.054-0.705z" />
    </Lini>
  );
}
