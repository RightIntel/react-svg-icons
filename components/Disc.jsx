...
export default function LiniDisc({
  ...
  return (
    <svg
      ...
      width={size}
      height={size}
      className={`Component Lini LiniDisc ${className}`}
      {...moreProps}
    >
      <g fill={color}>
