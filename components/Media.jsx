...
export default function LiniMedia({
  ...
  return (
    <svg
      ...
      width={size}
      height={size}
      className={`Component Lini LiniMedia ${className}`}
      {...moreProps}
    >
      <g fill={color}>
        ...
        <path d="M13.5 11c-0.827 0-1.5-0.673-1.5-1.5s0.673-1.5 1.5-1.5 1.5 0.673 1.5 1.5-0.673 1.5-1.5 1.5zM13.5 9c-0.276 0-0.5 0.224-0.5 0.5s0.224 0.5 0.5 0.5 0.5-0.224 0.5-0.5-0.224-0.5-0.5-0.5z" />
