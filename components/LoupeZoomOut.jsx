...
export default function LiniLoupeZoomOut({
  size = 20,
  color = "",
  className = "",
  ...moreProps
  ...
  return (
    <svg
      ...
      width={size}
      height={size}
      className={`Component Lini LiniLoupeZoomOut ${className}`}
      {...moreProps}
    >
      <g fill={color}>
        ...
        <path d="M12.5 11h-6c-0.276 0-0.5-0.224-0.5-0.5s0.224-0.5 0.5-0.5h6c0.276 0 0.5 0.224 0.5 0.5s-0.224 0.5-0.5 0.5z" />
      </g>
    </svg>
  );
}
