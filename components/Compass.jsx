...
export default function LiniCompass({
  ...
  return (
    <svg
      ...
      width={size}
      height={size}
      className={`Component Lini LiniCompass ${className}`}
      {...moreProps}
    >
      <g fill={color}>
        <path d="M10.5 13h-2c-0.276 0-0.5-0.224-0.5-0.5s0.224-0.5 0.5-0.5h2c0.276 0 0.5 0.224 0.5 0.5s-0.224 0.5-0.5 0.5z" />
        <path d="M15.5 11c-0.276 0-0.5 0.224-0.5 0.5v0.5h-1c-0.276 0-0.5 0.224-0.5 0.5s0.224 0.5 0.5 0.5h1v0.5c0 0.276 0.224 0.5 0.5 0.5s0.5-0.224 0.5-0.5v-2c0-0.276-0.224-0.5-0.5-0.5z" />
