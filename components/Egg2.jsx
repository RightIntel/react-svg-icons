...
export default function LiniEgg2({
  ...
  return (
    <svg
      ...
      width={size}
      height={size}
      className={`Component Lini LiniEgg2 ${className}`}
      {...moreProps}
    >
      <g fill={color}>
        ...
        <path d="M7.5 15c-2.481 0-4.5-2.019-4.5-4.5s2.019-4.5 4.5-4.5 4.5 2.019 4.5 4.5c0 2.481-2.019 4.5-4.5 4.5zM7.5 7c-1.93 0-3.5 1.57-3.5 3.5s1.57 3.5 3.5 3.5 3.5-1.57 3.5-3.5-1.57-3.5-3.5-3.5z" />
        <path d="M7.5 13c-0.276 0-0.5-0.224-0.5-0.5s0.224-0.5 0.5-0.5c0.827 0 1.5-0.673 1.5-1.5 0-0.276 0.224-0.5 0.5-0.5s0.5 0.224 0.5 0.5c0 1.378-1.122 2.5-2.5 2.5z" />
      </g>
    </svg>
  );
}
