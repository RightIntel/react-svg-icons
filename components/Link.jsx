...
export default function LiniLink({
  ...
  return (
    <svg
      ...
      width={size}
      height={size}
      className={`Component Lini LiniLink ${className}`}
      {...moreProps}
    >
      <g fill={color}>
        <path d="M6.5 14c-0.128 0-0.256-0.049-0.354-0.146-0.195-0.195-0.195-0.512 0-0.707l7-7c0.195-0.195 0.512-0.195 0.707 0s0.195 0.512 0 0.707l-7 7c-0.098 0.098-0.226 0.146-0.354 0.146z" />
