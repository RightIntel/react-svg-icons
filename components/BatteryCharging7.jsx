...
export default function LiniBatteryCharging7({
  ...
  return (
    <svg
      ...
      width={size}
      height={size}
      className={`Component Lini LiniBatteryCharging7 ${className}`}
      {...moreProps}
    >
      <g fill={color}>
        ...
        <path d="M6.5 14c-0.276 0-0.5-0.224-0.5-0.5v-1c0-0.276 0.224-0.5 0.5-0.5s0.5 0.224 0.5 0.5v1c0 0.276-0.224 0.5-0.5 0.5z" />
        <path d="M10.5 9c-0.276 0-0.5-0.224-0.5-0.5v-1c0-0.276 0.224-0.5 0.5-0.5s0.5 0.224 0.5 0.5v1c0 0.276-0.224 0.5-0.5 0.5z" />
