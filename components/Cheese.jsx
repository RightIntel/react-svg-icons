...
export default function LiniCheese({
  ...
  return (
    <svg
      ...
      width={size}
      height={size}
      className={`Component Lini LiniCheese ${className}`}
      {...moreProps}
    >
      <g fill={color}>
        ...
        <path d="M15.5 15c-0.827 0-1.5-0.673-1.5-1.5s0.673-1.5 1.5-1.5 1.5 0.673 1.5 1.5-0.673 1.5-1.5 1.5zM15.5 13c-0.276 0-0.5 0.224-0.5 0.5s0.224 0.5 0.5 0.5 0.5-0.224 0.5-0.5-0.224-0.5-0.5-0.5z" />
        <path d="M7 16c-1.103 0-2-0.897-2-2s0.897-2 2-2 2 0.897 2 2-0.897 2-2 2zM7 13c-0.551 0-1 0.449-1 1s0.449 1 1 1 1-0.449 1-1-0.449-1-1-1z" />
      </g>
    </svg>
  );
}
