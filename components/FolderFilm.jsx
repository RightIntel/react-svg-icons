...
export default function LiniFolderFilm({
  size = 20,
  color = "#333",
  className = "",
  ...moreProps
  ...
  return (
    <svg
      ...
      width={size}
      height={size}
      className={`Component Lini LiniFolderFilm ${className}`}
      {...moreProps}
    >
      <g fill={color}>
        ...
        <path d="M15.5 8h-11c-0.276 0-0.5 0.224-0.5 0.5v6c0 0.276 0.224 0.5 0.5 0.5h11c0.276 0 0.5-0.224 0.5-0.5v-6c0-0.276-0.224-0.5-0.5-0.5zM5 11h1v1h-1v-1zM7 9h6v5h-6v-5zM14 11h1v1h-1v-1zM15 10h-1v-1h1v1zM6 9v1h-1v-1h1zM5 13h1v1h-1v-1zM14 14v-1h1v1h-1z" />
      </g>
    </svg>
  );
}
