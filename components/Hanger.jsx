...
export default function LiniHanger({
  ...
  return (
    <svg
      ...
      width={size}
      height={size}
      className={`Component Lini LiniHanger ${className}`}
      {...moreProps}
    >
      <g fill={color}>
        <path d="M16 18h-13c-0.276 0-0.5-0.224-0.5-0.5s0.224-0.5 0.5-0.5h13c0.276 0 0.5 0.224 0.5 0.5s-0.224 0.5-0.5 0.5z" />
