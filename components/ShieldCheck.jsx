...
export default function LiniShieldCheck({
  size = 20,
  color = "#333",
  className = "",
  ...moreProps
  ...
  return (
    <svg
      ...
      width={size}
      height={size}
      className={`Component Lini LiniShieldCheck ${className}`}
      {...moreProps}
    >
      <g fill={color}>
        ...
        <path d="M8.5 12.5c-0.128 0-0.256-0.049-0.354-0.146l-2-2c-0.195-0.195-0.195-0.512 0-0.707s0.512-0.195 0.707 0l1.646 1.646 4.646-4.646c0.195-0.195 0.512-0.195 0.707 0s0.195 0.512 0 0.707l-5 5c-0.098 0.098-0.226 0.146-0.354 0.146z" />
      </g>
    </svg>
  );
}
