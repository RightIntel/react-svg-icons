...
export default function LiniPointerLeft2(props = {}) {
  props.name = "PointerLeft2";
  
  return (
    <Lini {...props}>
      <path d="M15.5 15c0.276 0 0.5-0.224 0.5-0.5s-0.224-0.5-0.5-0.5c-0.276 0-0.5 0.224-0.5 0.5s0.224 0.5 0.5 0.5z" />
