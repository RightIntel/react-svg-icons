...
export default function LiniNotification({
  ...
  return (
    <svg
      ...
      width={size}
      height={size}
      className={`Component Lini LiniNotification ${className}`}
      {...moreProps}
    >
      <g fill={color}>
        ...
        <path d="M9.5 15c-0.276 0-0.5-0.224-0.5-0.5v-1c0-0.276 0.224-0.5 0.5-0.5s0.5 0.224 0.5 0.5v1c0 0.276-0.224 0.5-0.5 0.5z" />
      </g>
    </svg>
  );
}
