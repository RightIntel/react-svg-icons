...
export default function LiniLamp({
  ...
  return (
    <svg
      ...
      width={size}
      height={size}
      className={`Component Lini LiniLamp ${className}`}
      {...moreProps}
    >
      <g fill={color}>
        <path d="M10.5 20h-1c-0.276 0-0.5-0.224-0.5-0.5s0.224-0.5 0.5-0.5h1c0.276 0 0.5 0.224 0.5 0.5s-0.224 0.5-0.5 0.5z" />
