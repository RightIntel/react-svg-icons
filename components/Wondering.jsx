...
export default function LiniWondering({
  ...
  return (
    <svg
      ...
      width={size}
      height={size}
      className={`Component Lini LiniWondering ${className}`}
      {...moreProps}
    >
      <g fill={color}>
        ...
        <path d="M12.5 15c-0.045 0-0.092-0.006-0.138-0.019l-7-2c-0.266-0.076-0.419-0.353-0.343-0.618s0.353-0.419 0.618-0.343l7 2c0.266 0.076 0.419 0.353 0.343 0.618-0.063 0.22-0.263 0.363-0.481 0.363z" />
      </g>
    </svg>
  );
}
