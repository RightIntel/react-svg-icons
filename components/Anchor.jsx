...
export default function LiniAnchor({
  ...
  return (
    <svg
      ...
      width={size}
      height={size}
      className={`Component Lini LiniAnchor ${className}`}
      {...moreProps}
    >
      <g fill={color}>
        <path d="M9.5 6c-1.378 0-2.5-1.122-2.5-2.5s1.122-2.5 2.5-2.5c1.378 0 2.5 1.122 2.5 2.5s-1.122 2.5-2.5 2.5zM9.5 2c-0.827 0-1.5 0.673-1.5 1.5s0.673 1.5 1.5 1.5 1.5-0.673 1.5-1.5-0.673-1.5-1.5-1.5z" />
