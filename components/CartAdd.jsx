...
export default function LiniCartAdd({
  size = 20,
  color = "",
  className = "",
  ...moreProps
  ...
  return (
    <svg
      ...
      width={size}
      height={size}
      className={`Component Lini LiniCartAdd ${className}`}
      {...moreProps}
    >
      <g fill={color}>
        ...
        <path d="M13.854 3.646c-0.195-0.195-0.512-0.195-0.707 0l-2.146 2.146v-5.293c0-0.276-0.224-0.5-0.5-0.5s-0.5 0.224-0.5 0.5v5.293l-2.146-2.146c-0.195-0.195-0.512-0.195-0.707 0s-0.195 0.512 0 0.707l3 3c0.098 0.098 0.226 0.146 0.354 0.146s0.256-0.049 0.354-0.146l3-3c0.195-0.195 0.195-0.512 0-0.707z" />
      </g>
    </svg>
  );
}
