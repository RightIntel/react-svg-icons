...
export default function LiniHddUp({
  ...
  return (
    <svg
      ...
      width={size}
      height={size}
      className={`Component Lini LiniHddUp ${className}`}
      {...moreProps}
    >
      <g fill={color}>
        ...
        <path d="M12.854 4.646l-3-3c-0.195-0.195-0.512-0.195-0.707 0l-3 3c-0.195 0.195-0.195 0.512 0 0.707s0.512 0.195 0.707 0l2.146-2.146v8.293c0 0.276 0.224 0.5 0.5 0.5s0.5-0.224 0.5-0.5v-8.293l2.146 2.146c0.098 0.098 0.226 0.146 0.354 0.146s0.256-0.049 0.354-0.146c0.195-0.195 0.195-0.512 0-0.707z" />
      </g>
    </svg>
  );
}
