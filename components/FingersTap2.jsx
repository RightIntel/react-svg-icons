...
export default function LiniFingersTap2({
  ...
  return (
    <svg
      ...
      width={size}
      height={size}
      className={`Component Lini LiniFingersTap2 ${className}`}
      {...moreProps}
    >
      <g fill={color}>
        ...
        <path d="M14.5 7c-0.276 0-0.5-0.224-0.5-0.5v-1c0-2.481-2.019-4.5-4.5-4.5s-4.5 2.019-4.5 4.5v1c0 0.276-0.224 0.5-0.5 0.5s-0.5-0.224-0.5-0.5v-1c0-3.033 2.467-5.5 5.5-5.5s5.5 2.467 5.5 5.5v1c0 0.276-0.224 0.5-0.5 0.5z" />
      </g>
    </svg>
  );
}
