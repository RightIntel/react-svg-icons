...
export default function LiniFactory2({
  ...
  return (
    <svg
      ...
      width={size}
      height={size}
      className={`Component Lini LiniFactory2 ${className}`}
      {...moreProps}
    >
      <g fill={color}>
        ...
        <path d="M2.5 6c-0.276 0-0.5-0.224-0.5-0.5 0-3.033 2.467-5.5 5.5-5.5 1.201 0 2.343 0.38 3.301 1.1 0.221 0.166 0.265 0.479 0.099 0.7s-0.479 0.265-0.7 0.099c-0.783-0.589-1.717-0.9-2.7-0.9-2.481 0-4.5 2.019-4.5 4.5 0 0.276-0.224 0.5-0.5 0.5z" />
        <path d="M15.5 5c-1.201 0-2.343-0.38-3.301-1.1-0.221-0.166-0.265-0.479-0.099-0.7s0.479-0.265 0.7-0.099c0.783 0.589 1.717 0.9 2.7 0.9 1.423 0 2.732-0.652 3.592-1.789 0.167-0.22 0.48-0.264 0.7-0.097s0.264 0.48 0.097 0.7c-0.502 0.664-1.158 1.214-1.898 1.59-0.776 0.395-1.614 0.595-2.491 0.595z" />
      </g>
    </svg>
  );
}
