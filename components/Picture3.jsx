...
export default function LiniPicture3({
  ...
  return (
    <svg
      ...
      width={size}
      height={size}
      className={`Component Lini LiniPicture3 ${className}`}
      {...moreProps}
    >
      <g fill={color}>
        ...
        <path d="M17.5 18h-7c-0.276 0-0.5-0.224-0.5-0.5s0.224-0.5 0.5-0.5h7c0.276 0 0.5 0.224 0.5 0.5s-0.224 0.5-0.5 0.5z" />
