...
export default function LiniContacts({
  ...
  return (
    <svg
      ...
      width={size}
      height={size}
      className={`Component Lini LiniContacts ${className}`}
      {...moreProps}
    >
      <g fill={color}>
        ...
        <path d="M11 10c-1.103 0-2-0.897-2-2s0.897-2 2-2c1.103 0 2 0.897 2 2s-0.897 2-2 2zM11 7c-0.551 0-1 0.449-1 1s0.449 1 1 1 1-0.449 1-1-0.449-1-1-1z" />
      </g>
    </svg>
  );
}
